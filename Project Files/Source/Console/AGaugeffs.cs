...
namespace Thetis.PowerSDR
{
    public class AGauge : Control
    {
        ...
        public bool PowerIsOn { get => powerIsOn; set => powerIsOn = value; }
        ...
        public AGauge(Thetis.Console c)
        {
            ...
            this.Font = new_font;
            gaugeBitmap = new Bitmap(c.picSMeter.Width, c.picSMeter.Height, PixelFormat.Format24bppRgb);
            this.PerformLayout();
        }
        ...
        public void PaintGauge(PaintEventArgs pe)
        {
            try
            {
                if (display_engine == Thetis.DisplayEngine.GDI_PLUS || PowerIsOn)
                {
