...
#region cmaster method definitions
  ...
  [DllImport("ChannelMaster.dll", EntryPoint = "build_date",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern IntPtr Build_date();

  // cmaster

  [DllImport("ChannelMaster.dll", EntryPoint = "SetRadioStructure",
             CallingConvention = CallingConvention.Cdecl)]
  ...
  [DllImport("ChannelMaster.dll", EntryPoint = "CreateRadio",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern void CreateRadio();

  [DllImport("ChannelMaster.dll", EntryPoint = "DestroyRadio",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern void DestroyRadio();

  [DllImport("ChannelMaster.dll", EntryPoint = "set_cmdefault_rates",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern void SetCMDefaultRates(int *xcm_inrates, int aud_outrate,
                                              int *rcvr_ch_outrates, int *xmtr_ch_outrates);

  [DllImport("ChannelMaster.dll", EntryPoint = "SetXcmInrate",
             CallingConvention = CallingConvention.Cdecl)]
  ...
  [DllImport("ChannelMaster.dll", EntryPoint = "getInputRate",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern int GetInputRate(int stype, int id);

  [DllImport("ChannelMaster.dll", EntryPoint = "getChannelOutputRate",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern int GetChannelOutputRate(int stype, int id);

  // router

  [DllImport("ChannelMaster.dll", EntryPoint = "LoadRouterAll",
             CallingConvention = CallingConvention.Cdecl)]
  ...
  [DllImport("ChannelMaster.dll", EntryPoint = "LoadRouterControlBit",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern void LoadRouterControlBit(void *ptr, int id, int var_number, int bit);

  // display setup

  [DllImport("ChannelMaster.dll", EntryPoint = "SetTopPan3Run",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern void SetTopPan3Run(bool run);

  [DllImport("ChannelMaster.dll", EntryPoint = "SetRunPanadapter",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern void SetRunPanadapter(int id, bool run);

  // puresignal setup

  [DllImport("ChannelMaster.dll", EntryPoint = "SetPSTxIdx",
             CallingConvention = CallingConvention.Cdecl)]
  public static extern void SetPSTxIdx(int id, int idx);

  [DllImport("ChannelMaster.dll", EntryPoint = "SetPSRxIdx",
             CallingConvention = CallingConvention.Cdecl)]
  ...
  [DllImport("wdsp.dll", EntryPoint = "SetSiphonInsize",
             CallingConvention = CallingConvention.Cdecl)]
...
#region logic calls
  ...
  public static void CMCreateCMaster() {
    ...
    fixed(int *pcmSPC = cmSPC, pcmIbSize = cmInboundSize) cmaster.SetRadioStructure(
        8, cmRCVR, 1, cmSubRCVR, 1, pcmSPC, pcmIbSize, 1536000, 48000, 384000);
    ...
    // set default rates
    int[] xcm_inrates =
        new int[8] { 192000, 192000, 192000, 192000, 192000, 48000, 192000, 192000 };
    ...
    case RadioProtocol.USB:
      if (ps_loopback) {
        ...
        case HPSDRModel.ANAN100B:
          ...
          fixed(int *pstreams = &TWO_DDC_nstreams[0], pfunction = &TWO_DDC_Function[0],
                pcallid = &TWO_DDC_Callid[0])
        ...
        case HPSDRModel.ANAN100:
          ...
          fixed(int *pstreams = &FOUR_DDC_nstreams[0], pfunction = &FOUR_DDC_Function[0],
                pcallid = &FOUR_DDC_Callid[0])
        ...
        case HPSDRModel.ANAN8000D:
          ...
          fixed(int *pstreams = &FIVE_DDC_nstreams[0], pfunction = &FIVE_DDC_Function[0],
                pcallid = &FIVE_DDC_Callid[0])
              LoadRouterAll((void *)0, 0, 3, 2, 8, pstreams, pfunction, pcallid);
          break;
        }
      } else {
    ...
    case RadioProtocol.ETH:
      if (ps_loopback) // for test purposes
      {
        ...
        case HPSDRModel.ANAN8000D:
          ...
          fixed(int *pstreams = &Angelia_nstreams_PSTest[0],
                pfunction = &Angelia_Function_PSTest[0], pcallid = &Angelia_Callid_PSTest[0])
        ...
        case HPSDRModel.ANAN100B:
          ...
          fixed(int *pstreams = &HermesE_nstreams[0], pfunction = &HermesE_Function[0],
                pcallid = &HermesE_Callid[0])
        ...
        case HPSDRModel.ANAN8000D:
          ...
          fixed(int *pstreams = &Angelia_nstreams[0], pfunction = &Angelia_Function[0],
                pcallid = &Angelia_Callid[0])
  ...
  public static void CMSetFRXNBRun(int id) {
    ...
    case 0:
      ...
      break;
    case 1:
      run = Audio.console.specRX.GetSpecRX(1).NBOn && Audio.console.RX2Enabled;
  ...
  public static void CMSetFRXNB2Run(int id) {
    ...
    case 0:
      ...
      break;
    case 1:
      run = Audio.console.specRX.GetSpecRX(1).NB2On && Audio.console.RX2Enabled;
  ...
  public static void CMSetSRXWavePlayRun(int id) {
    ...
    switch (id) {
    case 0:
      run = Audio.WavePlayback && WaveThing.wave_file_reader[0] != null;
      break;
    case 1:
      run = Audio.WavePlayback && WaveThing.wave_file_reader[1] != null && Audio.console.RX2Enabled;
      break;
    }
  ...
  public static void CMSetSRXWaveRecordRun(int id) {
    ...
    switch (id) {
    case 0:
      run = Audio.WaveRecord && WaveThing.wave_file_writer[0] != null;
      break;
    case 1:
      run = Audio.WaveRecord && WaveThing.wave_file_writer[1] != null && Audio.console.RX2Enabled;
      break;
    }
  ...
  public static void CMSetTXAVoxRun(int id) {
    ...
    bool run =
        Audio.VOXEnabled &&
        (mode == DSPMode.LSB || mode == DSPMode.USB || mode == DSPMode.DSB || mode == DSPMode.AM ||
         mode == DSPMode.SAM || mode == DSPMode.FM || mode == DSPMode.DIGL || mode == DSPMode.DIGU);
  ...
  public static void CMSetTXAPanelGain1(int channel) {
    double gain = 1.0;
    DSPMode mode = Audio.TXDSPMode;
    if ((!Audio.VACEnabled && (mode == DSPMode.LSB || mode == DSPMode.USB || mode == DSPMode.DSB ||
                               mode == DSPMode.AM || mode == DSPMode.SAM || mode == DSPMode.FM ||
                               mode == DSPMode.DIGL || mode == DSPMode.DIGU)) ||
        (Audio.VACEnabled && Audio.VACBypass &&
         (mode == DSPMode.DIGL || mode == DSPMode.DIGU || mode == DSPMode.LSB ||
          mode == DSPMode.USB || mode == DSPMode.DSB || mode == DSPMode.AM || mode == DSPMode.SAM ||
          mode == DSPMode.FM))) {
  ...
  public static void CMSetScopeRun(int id, bool run) { Scope.dscope[id].Run = run; }

  public static void CMSetTXOutputLevelRun() {
    bool run = false; // /* Audio.console.CurrentModel != Model.HERMES && */
                      // !Audio.console.PennyLanePresent;
...
#region rxa
  ...
  public static rxa Getrxa(int rx) { return rxa[rx]; }
...
#region wideband
  ...
  public static wideband Getwb(int adc) {
    ...
    if (wideband[adc].WindowState == FormWindowState.Minimized)
      wideband[adc].WindowState = FormWindowState.Normal; // MW0LGE
...
unsafe static class VOX {
  unsafe public static void PushVox(int id, int active) { Audio.VOXActive = (active == 1); }
}
#endregion
  ...
  unsafe public void wplay(int state, double *data) {
    if (run && (condx == state)) {
      if (System.Threading.Interlocked.Exchange(ref busy, 1) != 1) {
        ...
        fixed(float *pleft = &left[0]) fixed(float *pright = &right[0]) {
                                 ...
                                 // calling with transmit data)
    {
      if (System.Threading.Interlocked.Exchange(ref busy, 1) != 1) {
        fixed(float *pleft = &left[0], pright = &right[0], pltemp = &ltemp[0], prtemp = &rtemp[0]) {
          ...
          {
            if ((state == 0) &&
                rxpre) // getting receive data and want receive data for 'pre' position
            {
              int rcvr_inrate = cmaster.GetInputRate(
                  0, id); // could just read these from WaveThing.wave_file_writer[id]
              ...
              if (WaveThing.wave_file_writer[id].BaseRate != rcvr_inrate) {
                int outsamps;
                WDSP.xresampleFV(pleft, pltemp, rcvr_insize, &outsamps,
                                 WaveThing.wave_file_writer[id].RcvrResampL);
                WDSP.xresampleFV(pright, prtemp, rcvr_insize, &outsamps,
                                 WaveThing.wave_file_writer[id].RcvrResampR);
            ...
            if ((state == 1) &&
                txpre) // getting transmit data and want transmit data for 'pre' position
            {
              ...
              if (WaveThing.wave_file_writer[id].BaseRate != xmtr_inrate) {
                int outsamps;
                WDSP.xresampleFV(pleft, pltemp, xmtr_insize, &outsamps,
                                 WaveThing.wave_file_writer[id].XmtrResampL);
                WDSP.xresampleFV(pright, prtemp, xmtr_insize, &outsamps,
                                 WaveThing.wave_file_writer[id].XmtrResampR);
                WaveThing.wave_file_writer[id].AddWriteBuffer(pltemp, prtemp, outsamps);
              } else {
          ...
          {
            if ((state == 0) &&
                !rxpre) // getting receive data and want receive data for 'post' position
            {
              ...
              if (WaveThing.wave_file_writer[id].BaseRate != rcvr_outrate) {
                int outsamps;
                WDSP.xresampleFV(pleft, pltemp, rcvr_outsize, &outsamps,
                                 WaveThing.wave_file_writer[id].RcvrResampL);
                WDSP.xresampleFV(pright, prtemp, rcvr_outsize, &outsamps,
                                 WaveThing.wave_file_writer[id].RcvrResampR);
                WaveThing.wave_file_writer[id].AddWriteBuffer(pltemp, prtemp, outsamps);
              } else
            ...
            if ((state == 1) &&
                !txpre) // getting transmit data and want transmit data for 'post' position
            {
              ...
              if (WaveThing.wave_file_writer[id].BaseRate != xmtr_outrate) {
                int outsamps;
                WDSP.xresampleFV(pleft, pltemp, xmtr_outsize, &outsamps,
                                 WaveThing.wave_file_writer[id].XmtrResampL);
                WDSP.xresampleFV(pright, prtemp, xmtr_outsize, &outsamps,
                                 WaveThing.wave_file_writer[id].XmtrResampR);
                WaveThing.wave_file_writer[id].AddWriteBuffer(pltemp, prtemp, outsamps);
              } else {
