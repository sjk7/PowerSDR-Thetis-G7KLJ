...
#region Constructor and Destructor
  ...
  public Setup(Console c) {
    ...
    // MW0LGE node: this will allways cause the change event to fire, as the combobox does not
    // contain any default value it is bypassed in the event by use of the initializing flag, and is
    // then forced through in ForceAllEvents
    if (comboRadioModel.Text == "")
    ...
    if (comboCATPTTPort.Items.Count > 0)
      comboCATPTTPort.SelectedIndex = 0;
    ...
    RefreshSkinList(); // moved down the initialisation order, so we at least know if we are gdi or
                       // dx, only build the list
    ...
    if (comboDSPPhoneRXBuf.SelectedIndex < 0 ||
        comboDSPPhoneRXBuf.SelectedIndex >= comboDSPPhoneRXBuf.Items.Count)
      comboDSPPhoneRXBuf.SelectedIndex = comboDSPPhoneRXBuf.Items.Count - 1;
    if (comboDSPPhoneTXBuf.SelectedIndex < 0 ||
        comboDSPPhoneTXBuf.SelectedIndex >= comboDSPPhoneTXBuf.Items.Count)
...
#region Init Routines
  ...
  private void InitDisplayTab() {
    ...
    // MW0LGE in the case where we don't have a setting in the db, this function (initdisplaytab) is
    // called, use console instead
...
#region Misc Routines
  ...
  private void RefreshSkinList() {
    ...
    if (!Directory.Exists(path)) {
      MessageBox.Show("The console presentation files (skins) were not found.\n" +
                      ...
                      "Skins files not found", MessageBoxButtons.OK, MessageBoxIcon.Error);
      return;
    }
    ...
    foreach (string PAHostName in Audio.GetPAHosts()) {
      if (Audio.GetPAInputDevices(host_index).Count > 0 ||
        ...
        if (PAHostName != "Windows WASAPI")
                            /*/
        // G7KLJ does not know why WASAPI is barred. There should be a comment stating why if you
        // really mean it!
        {
...
#if (DEBUG)
      else if (c.GetType() == typeof(GroupBox) || c.GetType() == typeof(CheckBox) ||
               c.GetType() == typeof(ComboBox) || c.GetType() == typeof(NumericUpDown) ||
               c.GetType() == typeof(RadioButton) || c.GetType() == typeof(TextBox) ||
  ...
  public void getOptions2() {
    // MW0LGE moved to dictionary, as control names are unique, and does away with old loop through
    // every control to find the one we want
    ...
    if (comboTXProfileName.SelectedIndex < 0 && comboTXProfileName.Items.Count > 0)
  ...
  public string TXProfile {
    get { return comboTXProfileName != null ? comboTXProfileName.Text : ""; }
    set {
      if (comboTXProfileName != null)
        comboTXProfileName.Text = value;
    }
  }
  ...
  private bool CheckTXProfileChanged() {
    DataRow[] rows = DB.ds.Tables["TxProfile"].Select("'" + current_profile + "' = Name");
  ...
  public void UpdateWaterfallBandInfo() {
    if (!initializing) {
      ...
      case Band.B160M:
        ...
        break;
      case Band.B80M:
        txtWaterFallBandLevel.Text = "80 meters";
        break;
      case Band.B60M:
        txtWaterFallBandLevel.Text = "60 meters";
        break;
      case Band.B40M:
        txtWaterFallBandLevel.Text = "40 meters";
        break;
      case Band.B30M:
        txtWaterFallBandLevel.Text = "30 meters";
        break;
      case Band.B20M:
        txtWaterFallBandLevel.Text = "20 meters";
        break;
      case Band.B17M:
        txtWaterFallBandLevel.Text = "17 meters";
        break;
      case Band.B15M:
        txtWaterFallBandLevel.Text = "15 meters";
        break;
      case Band.B12M:
        txtWaterFallBandLevel.Text = "12 meters";
        break;
      case Band.B10M:
        txtWaterFallBandLevel.Text = "10 meters";
        break;
      case Band.B6M:
        txtWaterFallBandLevel.Text = "6 meters";
        break;
      case Band.WWV:
        txtWaterFallBandLevel.Text = "WWV";
        break;
      case Band.BLMF:
      ...
      case Band.B120M:
        ...
        break;
      case Band.B90M:
        txtWaterFallBandLevel.Text = "90 meters";
        break;
      case Band.B61M:
        txtWaterFallBandLevel.Text = "60 meters";
        break;
      case Band.B49M:
        txtWaterFallBandLevel.Text = "49 meters";
        break;
      case Band.B41M:
        txtWaterFallBandLevel.Text = "41 meters";
        break;
      case Band.B31M:
        txtWaterFallBandLevel.Text = "31 meters";
        break;
      case Band.B25M:
        txtWaterFallBandLevel.Text = "25 meters";
        break;
      case Band.B22M:
        txtWaterFallBandLevel.Text = "22 meters";
        break;
      case Band.B19M:
        txtWaterFallBandLevel.Text = "19 meters";
        break;
      case Band.B16M:
        txtWaterFallBandLevel.Text = "16 meters";
        break;
      case Band.B14M:
        txtWaterFallBandLevel.Text = "14 meters";
        break;
      case Band.B13M:
        txtWaterFallBandLevel.Text = "13 meters";
        break;
      case Band.B11M:
        txtWaterFallBandLevel.Text = "11 meters";
        break;

      case Band.GEN:
        txtWaterFallBandLevel.Text = "General";
        break;
      default:
        txtWaterFallBandLevel.Text = "2M & VHF+";
        break;
      }
      ...
      case Band.B6M:
        ...
        break;
      case Band.WWV:
        txtRX2WaterFallBandLevel.Text = "WWV";
        break;
      case Band.GEN:
        txtRX2WaterFallBandLevel.Text = "General";
        break;
      default:
        txtRX2WaterFallBandLevel.Text = "2M & VHF+";
        break;
      }
    }
  }
  ...
  public void UpdateDisplayGridBandInfo() {
    if (!initializing) {
      ...
      case Band.B10M:
        ...
        break;
      case Band.B6M:
        txtDisplayGridBandLevel.Text = "6 meters";
        break;
      case Band.WWV:
        txtDisplayGridBandLevel.Text = "WWV";
        break;
      ...
      // - end lge
      case Band.GEN:
        txtDisplayGridBandLevel.Text = "General";
        break;
      default:
        txtDisplayGridBandLevel.Text = "2M & VHF+";
        break;
      }
      switch (console.RX2Band) {
      case Band.B160M:
      ...
      case Band.B6M:
        ...
        break;
      case Band.WWV:
        txtRX2DisplayGridBandLevel.Text = "WWV";
        break;
      case Band.GEN:
        txtRX2DisplayGridBandLevel.Text = "General";
        break;
      default:
        txtRX2DisplayGridBandLevel.Text = "2M & VHF+";
        break;
      }
    }
  }

  public void UpdateTXDisplayFFT() { tbTXDisplayFFTSize_Scroll(this, EventArgs.Empty); }
...
#region Properties
  ...
  public bool AndromedaCATEnabled {
    ...
    set {
      if (chkEnableAndromeda != null)
        chkEnableAndromeda.Checked = value;
    }
  }
  ...
  public bool GanymedeCATEnabled {
    ...
    set {
      if (chkEnableGanymede != null)
        chkEnableGanymede.Checked = value;
    }
  }
  ...
  public int RX2AGCHang {
    ...
    set {
      if (udDSPAGCRX2HangTime != null)
        udDSPAGCRX2HangTime.Value = value;
    }
  }
  ...
  public bool CWIambic {
    ...
    set {
      if (chkCWKeyerIambic != null)
        chkCWKeyerIambic.Checked = value;
    }
  }
  ...
  public int VOXSens {
    ...
    set {
      if (udDEXPThreshold != null)
        udDEXPThreshold.Value = value;
    }
  }

  public bool NoiseGateEnabled {
    get {
      if (chkDEXPEnable != null)
        return chkDEXPEnable.Checked;
    ...
    set {
      if (chkCWBreakInEnabled != null) {
        if (chkCWBreakInEnabled.CheckState == value)
          chkCWBreakInEnabled_CheckStateChanged(this, EventArgs.Empty);
  ...
  public bool VOXEnable {
    get {
      if (chkVOXEnable != null)
        return chkVOXEnable.Checked;
  ...
  public int[] CFCCOMPEQ {
    ...
    set {
      ...
      tbCFCPEQGAIN.Value =
          Math.Max(tbCFCPEQGAIN.Minimum, Math.Min(tbCFCPEQGAIN.Maximum, value[11]));
...
#region General Tab Event Handlers
  ...
  public void AddHPSDRPages() {
    ...
    if (console.CurrentHPSDRModel == HPSDRModel.HERMES ||
      ...
      if (AndromedaCATEnabled)
        tpApolloControl.Text = "Andromeda";
    } else {
      if (tcGeneral.TabPages.Contains(tpApolloControl)) {
        tcGeneral.TabPages.Remove(tpApolloControl);
        tcGeneral.SelectedIndex = 0;
    ...
    if (chkGeneralRXOnly.Focused && !chkGeneralRXOnly.Checked) {
      DialogResult dr = MessageBox.Show(
          "Unchecking Receive Only while in Unsupported Card mode may \n" +
              ...
              "to enable transmit?",
          "Warning: Enable Transmit?", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
  ...
  private void btnGeneralCalFreqStart_Click(object sender, System.EventArgs e) {
    ...
    Thread t = new Thread(new ThreadStart(CalibrateFreq)) { Name = "Freq Calibration Thread",
                                                            IsBackground = true,
  ...
  private void btnGeneralCalLevelStart_Click(object sender, System.EventArgs e) {
    ...
    Thread t = new Thread(new ThreadStart(CalibrateLevel)) {
      Name = "Level Calibration Thread", IsBackground = true, Priority = ThreadPriority.AboveNormal
    };
    t.Start();
  ...
  private void btnCalLevel_Click(object sender, System.EventArgs e) {
    ...
    Thread t = new Thread(new ThreadStart(CalibrateRX2Level)) { Name = "Level Calibration Thread",
                                                                IsBackground = true,
  ...
  private void CalibrateFreq() {
    ...
    if (done)
      MessageBox.Show("Frequency Calibration complete.");
  ...
  private void CalibrateLevel() {
    ...
    if (done)
      MessageBox.Show("Level Calibration complete.");
  ...
  private void comboGeneralProcessPriority_SelectedIndexChanged(object sender, System.EventArgs e) {
    ...
    if (comboGeneralProcessPriority.Text == "Real Time" && comboGeneralProcessPriority.Focused) {
      DialogResult dr = MessageBox.Show(
          ...
          "Warning: Realtime Not Recommended", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
      if (dr == DialogResult.No) {
...
#region Audio Tab Event Handlers
  ...
  private void comboAudioInput3_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (comboAudioInput3.SelectedIndex < 0)
      return;
  ...
  private void comboAudioOutput2_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (comboAudioOutput2.SelectedIndex < 0)
      return;
    if (refreshing)
      return;
  ...
  private void comboAudioOutput3_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (comboAudioOutput3.SelectedIndex < 0)
      return;
  ...
  public void forceAudioSampleRate1(String rate) { comboAudioSampleRate1.Text = rate; }

  public void forceAudioSampleRateRX2(String rate) { comboAudioSampleRateRX2.Text = rate; }
  ...
  private void comboAudioSampleRate1_SelectedIndexChanged(object sender, System.EventArgs e) {
    ...
    if (new_rate != old_rate || initializing) {
      ...
      case RadioProtocol.ETH:
        // turn OFF the DSP channels so they get flushed out (must do while data is flowing to get
        // slew-down and flush)
        ...
        // flush any buffers where these old-rate packets may be stored ... this is done via
        // operations in SetXcmInrate()

        // in the property SampleRate1:
        //    (1) the new samplerate will be sent to the DDC
        //    (2) SetXcmInrate() is called by Audio.SampleRate1 which is called by
        //    console.SampleRate1
      ...
      case RadioProtocol.USB:
        // turn OFF the RX DSP channels so they get flushed out (must do while data is flowing to
        // get slew-down and flush)
        ...
        // flush any buffers where these old-rate packets may be stored ... this is done via
        // operations in SetXcmInrate() in the property SampleRate1:  SetXcmInrate() is called by
  ...
  private void comboAudioSampleRateRX2_SelectedIndexChanged(object sender, System.EventArgs e) {
    ...
    if ((NetworkIO.CurrentRadioProtocol == RadioProtocol.ETH) &&
      ...
      // turn OFF the DSP channel so it gets flushed out (must do while data is flowing to get
      // slew-down and flush)
      ...
      if (console.PowerOn && console.VAC2Enabled && !initializing)
        Audio.EnableVAC2(false);
      // turn OFF the DDC for RX2; had to add rx2_enabled as a parameter to UpdateReceivers() to do
      // this --- THIS IS S HACK.  BETTER WAY?
      console.UpdateDDCs(false);
      ...
      //    (1) the new samplerate will be sent to the DDC
      //    (2) SetXcmInrate() is called by Audio.SampleRateRX2 which is called by
      //    console.SampleRateRX2
      console.SampleRateRX2 = new_rate;
      // set the corresponding new buffer size
      int new_size = cmaster.GetBuffSize(new_rate);
      ...
      // turn the DDC for RX2 back ON; had to add rx2_enabled as a parameter to UpdateReceivers() to
      // do this
      if (was_enabled) {
        console.UpdateDDCs(true);
        // wait for samples at the new rate to be received
  ...
  private void comboAudioSampleRate2_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (comboAudioSampleRate2.SelectedIndex < 0)
      return;
  ...
  private void comboAudioSampleRate3_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (comboAudioSampleRate3.SelectedIndex < 0)
      return;
  ...
  private void comboAudioBuffer2_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (comboAudioBuffer2.SelectedIndex < 0)
      return;
  ...
  private void comboAudioBuffer3_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (comboAudioBuffer3.SelectedIndex < 0)
      return;
  ...
  private void chk20dbMicBoost_CheckedChanged(object sender, System.EventArgs e) {
    if (chk20dbMicBoost.Checked)
      udVOXGain_ValueChanged(this, e);
...
#region DSP Tab Event Handlers
  ...
  private void udLMSNR_ValueChanged(object sender, System.EventArgs e) {
    console.radio.GetDSPRX(0, 0).SetNRVals((int)udLMSNRtaps.Value, (int)udLMSNRdelay.Value,
                                           1e-6 * (double)udLMSNRgain.Value,
                                           1e-3 * (double)udLMSNRLeak.Value);
    console.radio.GetDSPRX(0, 1).SetNRVals((int)udLMSNRtaps.Value, (int)udLMSNRdelay.Value,
                                           1e-6 * (double)udLMSNRgain.Value,
                                           1e-3 * (double)udLMSNRLeak.Value);
  }

  private void udLMSNR2_ValueChanged(object sender, System.EventArgs e) {
    console.radio.GetDSPRX(1, 0).SetNRVals((int)udLMSNR2taps.Value, (int)udLMSNR2delay.Value,
                                           1e-6 * (double)udLMSNR2gain.Value,
                                           1e-3 * (double)udLMSNR2Leak.Value);
    console.radio.GetDSPRX(1, 1).SetNRVals((int)udLMSNR2taps.Value, (int)udLMSNR2delay.Value,
                                           1e-6 * (double)udLMSNR2gain.Value,
                                           1e-3 * (double)udLMSNR2Leak.Value);
  }
...
#region Image Reject
  ...
  private void udLMSANF_ValueChanged(object sender, System.EventArgs e) {
    console.radio.GetDSPRX(0, 0).SetANFVals((int)udLMSANFtaps.Value, (int)udLMSANFdelay.Value,
                                            1e-6 * (double)udLMSANFgain.Value,
                                            1e-3 * (double)udLMSANFLeak.Value);
    console.radio.GetDSPRX(0, 1).SetANFVals((int)udLMSANFtaps.Value, (int)udLMSANFdelay.Value,
                                            1e-6 * (double)udLMSANFgain.Value,
                                            1e-3 * (double)udLMSANFLeak.Value);
  }

  private void udLMSANF2_ValueChanged(object sender, System.EventArgs e) {
    console.radio.GetDSPRX(1, 0).SetANFVals((int)udLMSANF2taps.Value, (int)udLMSANF2delay.Value,
                                            1e-6 * (double)udLMSANF2gain.Value,
                                            1e-3 * (double)udLMSANF2Leak.Value);
    console.radio.GetDSPRX(1, 1).SetANFVals((int)udLMSANF2taps.Value, (int)udLMSANF2delay.Value,
                                            1e-6 * (double)udLMSANF2gain.Value,
                                            1e-3 * (double)udLMSANF2Leak.Value);
  }
...
#region Keyer
  ...
  private void chkCWBreakInEnabled_CheckStateChanged(object sender, EventArgs e) {
    ...
    case CheckState.Indeterminate:
      if ((console.CurrentHPSDRHardware == HPSDRHW.Orion ||
          ...
          (NetworkIO.FWCodeVersion >= 17) && !Alex.trx_ant_not_same) {
        console.BreakInEnabledState = chkCWBreakInEnabled.CheckState;
  ...
  private void comboKeyerConnPrimary_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (!CWInput.SetPrimaryInput(comboKeyerConnPrimary.Text)) {
      MessageBox.Show("Error using " + comboKeyerConnPrimary.Text + " for Keyer Primary Input.\n" +
                      ...
                      "Error using " + comboKeyerConnPrimary.Text, MessageBoxButtons.OK,
  ...
  private void comboKeyerConnSecondary_SelectedIndexChanged(object sender, System.EventArgs e) {
    ...
    if (comboKeyerConnSecondary.Text == "CAT") {
      if (!chkCATEnable.Checked) {
        MessageBox.Show(
            ...
            "CAT not enabled", MessageBoxButtons.OK, MessageBoxIcon.Hand);
    ...
    if (!CWInput.SetSecondaryInput(comboKeyerConnSecondary.Text)) {
      MessageBox.Show("Error using " + comboKeyerConnSecondary.Text +
                          ...
                          "The port may already be in use by another application.",
                      "Error using " + comboKeyerConnSecondary.Text, MessageBoxButtons.OK,
                      MessageBoxIcon.Error);
  ...
  private void comboKeyerConnKeyLine_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (comboKeyerConnKeyLine.SelectedIndex < 0)
      return;
    ...
    if (comboKeyerConnSecondary.Text == "CAT") {
      ...
      CWInput.SecondaryKeyLine = (KeyerLine)comboKeyerConnKeyLine.SelectedIndex;
  }

  private void comboKeyerConnPTTLine_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (comboKeyerConnPTTLine.SelectedIndex < 0)
      return;
    ...
    if (comboKeyerConnSecondary.Text == "CAT") {
      ...
      CWInput.SecondaryPTTLine = (KeyerLine)comboKeyerConnPTTLine.SelectedIndex;
  }
...
#region Transmit Tab Event Handlers
  ...
  private void TXBW() {
    MessageBox.Show(
        ...
        "Warning: Transmit Bandwidth", MessageBoxButtons.OK, MessageBoxIcon.Warning);
  }
  ...
  private bool loadTXProfile(String sProfileName) {
    DataRow[] rows = DB.ds.Tables["TxProfile"].Select("'" + sProfileName + "' = Name");

    if (rows.Length != 1) {
      MessageBox.Show("Database error reading TxProfile Table.", "Database error",
    ...
    udTXFilterLow.Value =
        Math.Min(Math.Max((int)dr["FilterLow"], udTXFilterLow.Minimum), udTXFilterLow.Maximum);
    udTXFilterHigh.Value =
        Math.Min(Math.Max((int)dr["FilterHigh"], udTXFilterHigh.Minimum), udTXFilterHigh.Maximum);
    ...
    // console.PWR = (int)dr["Power"];  // MW0LGE power is stored per band, leaving this in will
    // prevent the power per band from being recalled
    ...
    // udTXTunePower.Value = (int)dr["Tune_Power"];  //MW0LGE not applied here anymore, leave in
    // save incase we want to use it comboTXTUNMeter.Text = (string)dr["Tune_Meter_Type"];  //MW0LGE
    ...
    udPhRotFreq.Value = Math.Min(Math.Max((int)dr["CFCPhaseRotatorFreq"], udPhRotFreq.Minimum),
                                 udPhRotFreq.Maximum);
    udPHROTStages.Value = Math.Min(
        Math.Max((int)dr["CFCPhaseRotatorStages"], udPHROTStages.Minimum), udPHROTStages.Maximum);
    ...
    if (chkAutoSaveTXProfile.Checked) {
      ...
      if (CheckTXProfileChanged() && comboTXProfileName.Focused) {
        DialogResult result = MessageBox.Show(
            ...
            "Save Current Profile?", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
  ...
  private void btnTXProfileSave_Click(object sender, System.EventArgs e) {
    ...
    if (string.IsNullOrEmpty(name)) {
      MessageBox.Show("TX Profile Save cancelled", "TX Profile", MessageBoxButtons.OK,
    ...
    if (comboTXProfileName.Items.Contains(name)) {
      DialogResult result =
          MessageBox.Show("Are you sure you want to overwrite the " + name + " TX Profile?",
                          "Overwrite Profile?", MessageBoxButtons.YesNo, MessageBoxIcon.Question);

      if (result == DialogResult.No)
        return;

      foreach (DataRow d in from DataRow d in DB.ds.Tables["TxProfile"].Rows where(string)
                   d["Name"] == name select d) {
        dr = d;
        break;
      }
    } else {
...
#region PA Settings Tab Event Handlers
  ...
  private void btnPAGainCalibration_Click(object sender, System.EventArgs e) {
    ...
    DialogResult dr = MessageBox.Show(s, "Warning: Is dummy load properly connected?",
    ...
    Thread t =
        new Thread(CalibratePAGain) { Name = "PA Gain Calibration Thread", IsBackground = true,
                                      Priority = ThreadPriority.AboveNormal };
    t.Start();
  ...
  private void CalibratePAGain() {
    ...
    bool done = false;
    done = chkPANewCal.Checked ? console.CalibratePAGain2(progress, run, false)
                               : console.CalibratePAGain(progress, run, (int)udPACalPower.Value);
    if (done)
      MessageBox.Show("PA Gain Calibration complete.");
  ...
  private void btnPAGainReset_Click(object sender, System.EventArgs e) {
    ...
    if (console.CurrentHPSDRModel == HPSDRModel.HERMES ||
        (console.CurrentHPSDRModel == HPSDRModel.ANAN100D && chkBypassANANPASettings.Checked)) {
...
#region Appearance Tab Event Handlers
  ...
  private void clrbtnTXBackground_Changed(object sender, System.EventArgs e) {
    Display.TXDisplayBackgroundColor =
        Color.FromArgb(tbTXBackgroundAlpha.Value, clrbtnTXBackground.Color);
  }
...
#region CAT Setup event handlers
    ...
    if (chkCATEnable.Checked) {
      ...
      if (comboKeyerConnSecondary.Text == "CAT" && chkCATEnable.Focused) {
        MessageBox.Show(
            ...
            "CAT Disabled", MessageBoxButtons.OK, MessageBoxIcon.Information);
  ...
  private void ChkEnableAndromeda_CheckedChanged(object sender, EventArgs e) {
    ...
    if (comboAndromedaCATPort.Text == "" || !comboAndromedaCATPort.Text.StartsWith("COM")) {
      if (chkEnableAndromeda.Focused) {
        if (chkEnableAndromeda.Checked) {
          MessageBox.Show("The CAT port \"" + comboAndromedaCATPort.Text +
                          "\" is not a valid port.\n" + "Please select another port.");
          chkEnableAndromeda.Checked = false;
        }
      }
    ...
    if (chkEnableAndromeda.Checked && console.PTTBitBangEnabled &&
      ...
      MessageBox.Show("Andromeda CAT port cannot be the same as Bit Bang Port",
                      "Port Selection Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
      chkEnableAndromeda.Checked = false;
    }
    ...
    if (chkEnableAndromeda.Checked) {
      try {
        ...
        MessageBox.Show("Could not initialize Andromeda control.  Exception was:\n\n " +
                        ...
                        "Error Initializing Andromeda control", MessageBoxButtons.OK,
                        MessageBoxIcon.Error);
      }
    } else {
      if (comboKeyerConnSecondary.Text == "CAT" && chkCATEnable.Focused) {
  ...
  private void doEnablementOnBitBangEnable() {
    if (comboCATPTTPort.Text != "None" &&
        (chkCATPTT_RTS.Checked ||
         chkCATPTT_DTR.Checked)) // if RTS or DTR & port is not None, enable
    {
      chkCATPTTEnabled.Enabled = true;
    } else {
      chkCATPTTEnabled.Enabled = false;
  ...
  private void chkCATPTTEnabled_CheckedChanged(object sender, System.EventArgs e) {
    ...
    if (comboCATPTTPort.Text == "" ||
        (!comboCATPTTPort.Text.StartsWith("COM") && !comboCATPTTPort.Text.StartsWith("CAT"))) {
...
#region Test Tab Event Handlers
  ...
  public bool TTgenrun {
    ...
    set {
      ttgenrun = value;
      if (ttgenrun && !chkTestIMD.Checked)
        chkTestIMD.Checked = true;
  ...
  private void chkTestIMD_CheckedChanged(object sender, System.EventArgs e) {
    if (chkTestIMD.Checked) {
      ...
      if (!console.PowerOn) {
        MessageBox.Show("Power must be on to run this test.", "Power is off", MessageBoxButtons.OK,
                        MessageBoxIcon.Hand);
        chkTestIMD.Checked = false;
        return;
      }
  ...
  private void cmboSigGenRXMode_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (cmboSigGenRXMode.SelectedIndex < 0)
      return;
  ...
  private void cmboSigGenTXMode_SelectedIndexChanged(object sender, System.EventArgs e) {
    if (cmboSigGenTXMode.SelectedIndex < 0)
      return;
  ...
  private void btnImpulse_Click(object sender, System.EventArgs e) {
    Thread t = new Thread(new ThreadStart(ImpulseFunction)) { Name = "Impulse",
...
#region Other Event Handlers
  ...
  private void setButtonState(bool bSaving, bool bLoading) {
    if (m_bIgnoreButtonState)
      return; // not used after this is true, which is set in console_closing
  ...
  private void btnOK_Click(object sender, System.EventArgs e) {
    ...
    m_objSaveLoadThread = new Thread(new ThreadStart(PreSaveOptions)) {
      Name = "Save Options Thread", IsBackground = true, Priority = ThreadPriority.Lowest
    };
  ...
  private void btnCancel_Click(object sender, System.EventArgs e) {
    ...
    m_objSaveLoadThread = new Thread(new ThreadStart(PreGetOptions)) {
      Name = "Get Options Thread", IsBackground = true, Priority = ThreadPriority.Lowest
    };
    m_objSaveLoadThread.Start();
    this.Hide();
  }
  ...
  private void btnApply_Click(object sender, System.EventArgs e) {
    ...
    m_objSaveLoadThread = new Thread(new ThreadStart(ApplyOptions)) {
      Name = "Apply Options Thread", IsBackground = true, Priority = ThreadPriority.Lowest
    };
    m_objSaveLoadThread.Start();
  }
  ...
  private bool CompleteImport() {
    ...
    //-W2PA Import more carefully, allowing DBs created by previous versions to retain settings and
    // options
  ...
  private void txtKB_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e) {
    ...
    if (e.KeyCode != Keys.ShiftKey && e.KeyCode != Keys.ControlKey && e.KeyCode != Keys.Menu &&
        e.KeyCode != Keys.RMenu && e.KeyCode != Keys.LWin && e.KeyCode != Keys.RWin &&
        e.KeyCode != Keys.Apps)
...
#region Lost Focus Event Handlers
  ...
  private void udDSPNB_LostFocus(object sender, EventArgs e) { udDSPNB.Value = udDSPNB.Value; }
  ...
  private void udTXAF_LostFocus(object sender, EventArgs e) { udTXAF.Value = udTXAF.Value; }
  ...
  private void clrbtnMeterEdgeBackground_Changed(object sender, System.EventArgs e) {
    console.EdgeMeterBackgroundColor =
        Color.FromArgb(tbMeterEdgeBackgroundAlpha.Value, clrbtnMeterEdgeBackground.Color);
  ...
  private void setWaterFallCalculatedDelayText() {
    lblRX1WaterFallCalulatedDelayMS.Text =
        ((1000f / console.DisplayFPS) * Display.WaterfallUpdatePeriod).ToString("f2") + " (ms)";
    lblRX2WaterFallCalulatedDelayMS.Text =
        ((1000f / console.DisplayFPS) * Display.RX2WaterfallUpdatePeriod).ToString("f2") + " (ms)";
  }
  ...
  public void UpdateCustomTitle() { txtGenCustomTitle_TextChanged(this, EventArgs.Empty); }
  ...
  private void btnResetDB_Click(object sender, System.EventArgs e) {
    DialogResult dr =
        MessageBox.Show("This will close the program, make a copy of the current\n" +
  ...
  private void btnTXProfileDefImport_Click(object sender, System.EventArgs e) {
    ...
    DialogResult result =
        MessageBox.Show("Include this Additional TX profile in your profiles list?", "Include?",
    ...
    if (rows.Length != 1) {
      MessageBox.Show("Database error reading TXProfileDef Table.", "Database error",
                      MessageBoxButtons.OK, MessageBoxIcon.Error);
      return;
    }
  ...
  private void ExportCurrentTxProfile() {
    ...
    while (File.Exists(tempFN + ".xml")) {
      tempFN = fileName +
               Convert.ToString(i); // Get a slightly different file name if it already exists.
      i++;
    }
    fileName = tempFN + ".xml";
    ...
    try {
      exDS.WriteXml(fileName,
                    XmlWriteMode.WriteSchema); // Writing with schema is necessary for import
    } catch {
      MessageBox.Show("Can not write " + fileName + ".", "Export error", MessageBoxButtons.OK,
                      MessageBoxIcon.Error);
      return;
    }

    MessageBox.Show("Profile" + current_profile + " has been saved in file " + fileName, "Done",
  ...
  private void comboAppSkin_SelectedIndexChanged(object sender, EventArgs e) {
    if (initializing)
      return; // prevents call on getoptions, need to force call after options loaded MW0LGE
  ...
  private void chkAlexPresent_CheckedChanged(object sender, System.EventArgs e) {
    ...
    //        console.comboRX2Preamp.Visible = false; if (chkApolloPresent.Checked)
    //        chkApolloPresent.Checked = false;
    //        //  if (radGenModelHermes.Checked || radGenModelANAN10.Checked ||
    //        radGenModelANAN10E.Checked || radGenModelANAN100.Checked ||
    //        //  radGenModelANAN100D.Checked || radGenModelANAN200D.Checked)
    //        NetworkIO.SetHermesFilter(0);
    //    }
    //    else
    //    {
  ...
  private void chkPenOCrcv160_CheckedChanged(object sender, System.EventArgs e) {
    int val = 0;
    if (chkPenOCrcv1601.Checked)
      val += 1 << 0;
    if (chkPenOCrcv1602.Checked)
      val += 1 << 1;
    if (chkPenOCrcv1603.Checked)
      val += 1 << 2;
    if (chkPenOCrcv1604.Checked)
      val += 1 << 3;
    if (chkPenOCrcv1605.Checked)
      val += 1 << 4;
    if (chkPenOCrcv1606.Checked)
      val += 1 << 5;
    if (chkPenOCrcv1607.Checked)
      val += 1 << 6;
    ...
    console.PennyExtCtrlEnabled =
        chkPennyExtCtrl.Checked; // need side effect of this to push change to native code
  }

  private void chkPenOCxmit160_CheckedChanged(object sender, System.EventArgs e) {
    int val = 0;
    if (chkPenOCxmit1601.Checked)
      val += 1 << 0;
    if (chkPenOCxmit1602.Checked)
      val += 1 << 1;
    if (chkPenOCxmit1603.Checked)
      val += 1 << 2;
    if (chkPenOCxmit1604.Checked)
      val += 1 << 3;
    if (chkPenOCxmit1605.Checked)
      val += 1 << 4;
    if (chkPenOCxmit1606.Checked)
      val += 1 << 5;
    if (chkPenOCxmit1607.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv80_CheckedChanged(object sender, System.EventArgs e) {
    int val = 0;
    if (chkPenOCrcv801.Checked)
      val += 1 << 0;
    if (chkPenOCrcv802.Checked)
      val += 1 << 1;
    if (chkPenOCrcv803.Checked)
      val += 1 << 2;
    if (chkPenOCrcv804.Checked)
      val += 1 << 3;
    if (chkPenOCrcv805.Checked)
      val += 1 << 4;
    if (chkPenOCrcv806.Checked)
      val += 1 << 5;
    if (chkPenOCrcv807.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit80_CheckedChanged(object sender, System.EventArgs e) {
    int val = 0;
    if (chkPenOCxmit801.Checked)
      val += 1 << 0;
    if (chkPenOCxmit802.Checked)
      val += 1 << 1;
    if (chkPenOCxmit803.Checked)
      val += 1 << 2;
    if (chkPenOCxmit804.Checked)
      val += 1 << 3;
    if (chkPenOCxmit805.Checked)
      val += 1 << 4;
    if (chkPenOCxmit806.Checked)
      val += 1 << 5;
    if (chkPenOCxmit807.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv60_CheckedChanged(object sender, System.EventArgs e) {
    int val = 0;
    if (chkPenOCrcv601.Checked)
      val += 1 << 0;
    if (chkPenOCrcv602.Checked)
      val += 1 << 1;
    if (chkPenOCrcv603.Checked)
      val += 1 << 2;
    if (chkPenOCrcv604.Checked)
      val += 1 << 3;
    if (chkPenOCrcv605.Checked)
      val += 1 << 4;
    if (chkPenOCrcv606.Checked)
      val += 1 << 5;
    if (chkPenOCrcv607.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit60_CheckedChanged(object sender, System.EventArgs e) {
    int val = 0;
    if (chkPenOCxmit601.Checked)
      val += 1 << 0;
    if (chkPenOCxmit602.Checked)
      val += 1 << 1;
    if (chkPenOCxmit603.Checked)
      val += 1 << 2;
    if (chkPenOCxmit604.Checked)
      val += 1 << 3;
    if (chkPenOCxmit605.Checked)
      val += 1 << 4;
    if (chkPenOCxmit606.Checked)
      val += 1 << 5;
    if (chkPenOCxmit607.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv40_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCrcv401.Checked)
      val += 1 << 0;
    if (chkPenOCrcv402.Checked)
      val += 1 << 1;
    if (chkPenOCrcv403.Checked)
      val += 1 << 2;
    if (chkPenOCrcv404.Checked)
      val += 1 << 3;
    if (chkPenOCrcv405.Checked)
      val += 1 << 4;
    if (chkPenOCrcv406.Checked)
      val += 1 << 5;
    if (chkPenOCrcv407.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit40_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCxmit401.Checked)
      val += 1 << 0;
    if (chkPenOCxmit402.Checked)
      val += 1 << 1;
    if (chkPenOCxmit403.Checked)
      val += 1 << 2;
    if (chkPenOCxmit404.Checked)
      val += 1 << 3;
    if (chkPenOCxmit405.Checked)
      val += 1 << 4;
    if (chkPenOCxmit406.Checked)
      val += 1 << 5;
    if (chkPenOCxmit407.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv30_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCrcv301.Checked)
      val += 1 << 0;
    if (chkPenOCrcv302.Checked)
      val += 1 << 1;
    if (chkPenOCrcv303.Checked)
      val += 1 << 2;
    if (chkPenOCrcv304.Checked)
      val += 1 << 3;
    if (chkPenOCrcv305.Checked)
      val += 1 << 4;
    if (chkPenOCrcv306.Checked)
      val += 1 << 5;
    if (chkPenOCrcv307.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit30_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCxmit301.Checked)
      val += 1 << 0;
    if (chkPenOCxmit302.Checked)
      val += 1 << 1;
    if (chkPenOCxmit303.Checked)
      val += 1 << 2;
    if (chkPenOCxmit304.Checked)
      val += 1 << 3;
    if (chkPenOCxmit305.Checked)
      val += 1 << 4;
    if (chkPenOCxmit306.Checked)
      val += 1 << 5;
    if (chkPenOCxmit307.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv20_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCrcv201.Checked)
      val += 1 << 0;
    if (chkPenOCrcv202.Checked)
      val += 1 << 1;
    if (chkPenOCrcv203.Checked)
      val += 1 << 2;
    if (chkPenOCrcv204.Checked)
      val += 1 << 3;
    if (chkPenOCrcv205.Checked)
      val += 1 << 4;
    if (chkPenOCrcv206.Checked)
      val += 1 << 5;
    if (chkPenOCrcv207.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit20_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCxmit201.Checked)
      val += 1 << 0;
    if (chkPenOCxmit202.Checked)
      val += 1 << 1;
    if (chkPenOCxmit203.Checked)
      val += 1 << 2;
    if (chkPenOCxmit204.Checked)
      val += 1 << 3;
    if (chkPenOCxmit205.Checked)
      val += 1 << 4;
    if (chkPenOCxmit206.Checked)
      val += 1 << 5;
    if (chkPenOCxmit207.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv17_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCrcv171.Checked)
      val += 1 << 0;
    if (chkPenOCrcv172.Checked)
      val += 1 << 1;
    if (chkPenOCrcv173.Checked)
      val += 1 << 2;
    if (chkPenOCrcv174.Checked)
      val += 1 << 3;
    if (chkPenOCrcv175.Checked)
      val += 1 << 4;
    if (chkPenOCrcv176.Checked)
      val += 1 << 5;
    if (chkPenOCrcv177.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit17_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCxmit171.Checked)
      val += 1 << 0;
    if (chkPenOCxmit172.Checked)
      val += 1 << 1;
    if (chkPenOCxmit173.Checked)
      val += 1 << 2;
    if (chkPenOCxmit174.Checked)
      val += 1 << 3;
    if (chkPenOCxmit175.Checked)
      val += 1 << 4;
    if (chkPenOCxmit176.Checked)
      val += 1 << 5;
    if (chkPenOCxmit177.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv15_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCrcv151.Checked)
      val += 1 << 0;
    if (chkPenOCrcv152.Checked)
      val += 1 << 1;
    if (chkPenOCrcv153.Checked)
      val += 1 << 2;
    if (chkPenOCrcv154.Checked)
      val += 1 << 3;
    if (chkPenOCrcv155.Checked)
      val += 1 << 4;
    if (chkPenOCrcv156.Checked)
      val += 1 << 5;
    if (chkPenOCrcv157.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit15_CheckedChanged(object sender, System.EventArgs e) {
    int val = 0;
    if (chkPenOCxmit151.Checked)
      val += 1 << 0;
    if (chkPenOCxmit152.Checked)
      val += 1 << 1;
    if (chkPenOCxmit153.Checked)
      val += 1 << 2;
    if (chkPenOCxmit154.Checked)
      val += 1 << 3;
    if (chkPenOCxmit155.Checked)
      val += 1 << 4;
    if (chkPenOCxmit156.Checked)
      val += 1 << 5;
    if (chkPenOCxmit157.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv12_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCrcv121.Checked)
      val += 1 << 0;
    if (chkPenOCrcv122.Checked)
      val += 1 << 1;
    if (chkPenOCrcv123.Checked)
      val += 1 << 2;
    if (chkPenOCrcv124.Checked)
      val += 1 << 3;
    if (chkPenOCrcv125.Checked)
      val += 1 << 4;
    if (chkPenOCrcv126.Checked)
      val += 1 << 5;
    if (chkPenOCrcv127.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit12_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCxmit121.Checked)
      val += 1 << 0;
    if (chkPenOCxmit122.Checked)
      val += 1 << 1;
    if (chkPenOCxmit123.Checked)
      val += 1 << 2;
    if (chkPenOCxmit124.Checked)
      val += 1 << 3;
    if (chkPenOCxmit125.Checked)
      val += 1 << 4;
    if (chkPenOCxmit126.Checked)
      val += 1 << 5;
    if (chkPenOCxmit127.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv10_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCrcv101.Checked)
      val += 1 << 0;
    if (chkPenOCrcv102.Checked)
      val += 1 << 1;
    if (chkPenOCrcv103.Checked)
      val += 1 << 2;
    if (chkPenOCrcv104.Checked)
      val += 1 << 3;
    if (chkPenOCrcv105.Checked)
      val += 1 << 4;
    if (chkPenOCrcv106.Checked)
      val += 1 << 5;
    if (chkPenOCrcv107.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit10_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCxmit101.Checked)
      val += 1 << 0;
    if (chkPenOCxmit102.Checked)
      val += 1 << 1;
    if (chkPenOCxmit103.Checked)
      val += 1 << 2;
    if (chkPenOCxmit104.Checked)
      val += 1 << 3;
    if (chkPenOCxmit105.Checked)
      val += 1 << 4;
    if (chkPenOCxmit106.Checked)
      val += 1 << 5;
    if (chkPenOCxmit107.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv6_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCrcv61.Checked)
      val += 1 << 0;
    if (chkPenOCrcv62.Checked)
      val += 1 << 1;
    if (chkPenOCrcv63.Checked)
      val += 1 << 2;
    if (chkPenOCrcv64.Checked)
      val += 1 << 3;
    if (chkPenOCrcv65.Checked)
      val += 1 << 4;
    if (chkPenOCrcv66.Checked)
      val += 1 << 5;
    if (chkPenOCrcv67.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit6_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCxmit61.Checked)
      val += 1 << 0;
    if (chkPenOCxmit62.Checked)
      val += 1 << 1;
    if (chkPenOCxmit63.Checked)
      val += 1 << 2;
    if (chkPenOCxmit64.Checked)
      val += 1 << 3;
    if (chkPenOCxmit65.Checked)
      val += 1 << 4;
    if (chkPenOCxmit66.Checked)
      val += 1 << 5;
    if (chkPenOCxmit67.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcv2_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCrcv21.Checked)
      val += 1 << 0;
    if (chkPenOCrcv22.Checked)
      val += 1 << 1;
    if (chkPenOCrcv23.Checked)
      val += 1 << 2;
    if (chkPenOCrcv24.Checked)
      val += 1 << 3;
    if (chkPenOCrcv25.Checked)
      val += 1 << 4;
    if (chkPenOCrcv26.Checked)
      val += 1 << 5;
    if (chkPenOCrcv27.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmit2_CheckedChanged(object sender, System.EventArgs e) {
    ...
    int val = 0;
    if (chkPenOCxmit21.Checked)
      val += 1 << 0;
    if (chkPenOCxmit22.Checked)
      val += 1 << 1;
    if (chkPenOCxmit23.Checked)
      val += 1 << 2;
    if (chkPenOCxmit24.Checked)
      val += 1 << 3;
    if (chkPenOCxmit25.Checked)
      val += 1 << 4;
    if (chkPenOCxmit26.Checked)
      val += 1 << 5;
    if (chkPenOCxmit27.Checked)
      val += 1 << 6;
  ...
  private void radAlexR_6_CheckedChanged(object sender, System.EventArgs e) {
    if (radAlexR2_6.Checked) {
      if (chkBlockTxAnt2.Checked) {
        if (radAlexT2_6.Checked)
          radAlexT1_6.Checked = true;
  ...
  private void ProcessAlexAntCheckBox(object sender, Band band) {
    ...
    if (sender == null)
      return;
    if (sender.GetType() != typeof(CheckBoxTS))
      return;
    ...
    // find a name for the "winning" check box. In some radios the signals add, so multiple
    // selections would be bad.
    if (cboxes[2].Checked)
      Name = RXAntChk3Name;
  ...
  private void ProcessAlexAntRadioButton(object sender, Band band, bool is_xmit) {
    if (sender == null)
      return;
    if (sender.GetType() != typeof(RadioButtonTS))
      return;
  ...
  private void tpHPSDR_Paint(object sender, System.Windows.Forms.PaintEventArgs e) {
    if (console.PowerOn && console.CurrentHPSDRModel == HPSDRModel.HPSDR) {
      ...
      //{
      //    lblOzyFX2.Text =
      //    Convert.ToUInt32(JanusAudio.getFX2FirmwareVersionString()).ToString("Ozy FX2: 0000 00
      //    00");
      //}
      // catch (Exception)
      //{
      ...
      // JanusAudio.getMercuryFWVersion().ToString("Mercury: 0\\.0") : "Mercury: n/a";
      // if (lblMercury2FWVer.Visible)
      // lblMercury2FWVer.Text = console.MercuryPresent ?
      // JanusAudio.getMercury2FWVersion().ToString("Mercury2: 0\\.0") : "Mercury2: n/a"; if
      // (console.PennyPresent || console.PennyLanePresent) lblPenelopeFWVer.Text =
      // JanusAudio.getPenelopeFWVersion().ToString("Penny[Lane]: 0\\.0"); else
    ...
    // if (console.PowerOn && (radGenModelANAN10.Checked || radGenModelANAN10E.Checked ||
    // radGenModelANAN100.Checked || radGenModelANAN100D.Checked))
    //{
    //    //byte[] ver_bytes = new byte[1];
    //    //JanusAudio.GetMetisCodeVersion(ver_bytes);
    //    lblOzyFX2.Text = NetworkIO.FWCodeVersion.ToString("ANAN: 0\\.0");
    //    //ver_bytes[0].ToString("ANAN: 0\\.0"); lblOzyFWVer.Text = ""; lblMercuryFWVer.Text = "";
    //    lblMercury2FWVer.Text = "";
    //    lblPenelopeFWVer.Text = "";
    //}
    ...
    //    //ver_bytes[0].ToString("Orion: 0\\.0"); lblOzyFWVer.Text = ""; lblMercuryFWVer.Text = "";
    //    lblMercury2FWVer.Text = "";
    //    lblPenelopeFWVer.Text = "";
    //}
  }
  ...
  private void comboFRSRegion_SelectedIndexChanged(object sender, EventArgs e) // w5wc
  {
    ...
    if (!console.initializing) {
      setButtonState(true, false); // MW0LGE this causes an update of the whole DB, so disable
                                   // buttons while happening
  ...
  private string IPStringFromInt(Int32 addr) { return IPStringFromInt(addr, new StringBuilder()); }
  ...
  private void chkPenOCrcvVHF0_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF01.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF02.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF03.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF04.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF05.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF06.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF07.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF1_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF11.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF12.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF13.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF14.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF15.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF16.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF17.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF2_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF21.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF22.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF23.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF24.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF25.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF26.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF27.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF3_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF31.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF32.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF33.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF34.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF35.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF36.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF37.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF4_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF41.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF42.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF43.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF44.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF45.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF46.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF47.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF5_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF51.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF52.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF53.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF54.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF55.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF56.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF57.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF6_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF61.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF62.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF63.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF64.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF65.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF66.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF67.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF7_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF71.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF72.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF73.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF74.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF75.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF76.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF77.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF8_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF81.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF82.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF83.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF84.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF85.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF86.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF87.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF9_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF91.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF92.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF93.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF94.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF95.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF96.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF97.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF10_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF101.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF102.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF103.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF104.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF105.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF106.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF107.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCrcvVHF11_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCrcvVHF111.Checked)
      val += 1 << 0;
    if (chkPenOCrcvVHF112.Checked)
      val += 1 << 1;
    if (chkPenOCrcvVHF113.Checked)
      val += 1 << 2;
    if (chkPenOCrcvVHF114.Checked)
      val += 1 << 3;
    if (chkPenOCrcvVHF115.Checked)
      val += 1 << 4;
    if (chkPenOCrcvVHF116.Checked)
      val += 1 << 5;
    if (chkPenOCrcvVHF117.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF0_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF01.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF02.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF03.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF04.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF05.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF06.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF07.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF1_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF11.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF12.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF13.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF14.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF15.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF16.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF17.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF2_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF21.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF22.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF23.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF24.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF25.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF26.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF27.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF3_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF31.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF32.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF33.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF34.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF35.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF36.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF37.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF4_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF41.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF42.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF43.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF44.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF45.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF46.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF47.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF5_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF51.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF52.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF53.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF54.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF55.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF56.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF57.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF6_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF61.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF62.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF63.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF64.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF65.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF66.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF67.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF7_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF71.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF72.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF73.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF74.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF75.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF76.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF77.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF8_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF81.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF82.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF83.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF84.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF85.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF86.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF87.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF9_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF91.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF92.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF93.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF94.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF95.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF96.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF97.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF10_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF101.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF102.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF103.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF104.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF105.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF106.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF107.Checked)
      val += 1 << 6;
  ...
  private void chkPenOCxmitVHF11_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkPenOCxmitVHF111.Checked)
      val += 1 << 0;
    if (chkPenOCxmitVHF112.Checked)
      val += 1 << 1;
    if (chkPenOCxmitVHF113.Checked)
      val += 1 << 2;
    if (chkPenOCxmitVHF114.Checked)
      val += 1 << 3;
    if (chkPenOCxmitVHF115.Checked)
      val += 1 << 4;
    if (chkPenOCxmitVHF116.Checked)
      val += 1 << 5;
    if (chkPenOCxmitVHF117.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcvLMW_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcvLMW1.Checked)
      val += 1 << 0;
    if (chkOCrcvLMW2.Checked)
      val += 1 << 1;
    if (chkOCrcvLMW3.Checked)
      val += 1 << 2;
    if (chkOCrcvLMW4.Checked)
      val += 1 << 3;
    if (chkOCrcvLMW5.Checked)
      val += 1 << 4;
    if (chkOCrcvLMW6.Checked)
      val += 1 << 5;
    if (chkOCrcvLMW7.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv120_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv1201.Checked)
      val += 1 << 0;
    if (chkOCrcv1202.Checked)
      val += 1 << 1;
    if (chkOCrcv1203.Checked)
      val += 1 << 2;
    if (chkOCrcv1204.Checked)
      val += 1 << 3;
    if (chkOCrcv1205.Checked)
      val += 1 << 4;
    if (chkOCrcv1206.Checked)
      val += 1 << 5;
    if (chkOCrcv1207.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv90_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv901.Checked)
      val += 1 << 0;
    if (chkOCrcv902.Checked)
      val += 1 << 1;
    if (chkOCrcv903.Checked)
      val += 1 << 2;
    if (chkOCrcv904.Checked)
      val += 1 << 3;
    if (chkOCrcv905.Checked)
      val += 1 << 4;
    if (chkOCrcv906.Checked)
      val += 1 << 5;
    if (chkOCrcv907.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv61_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv611.Checked)
      val += 1 << 0;
    if (chkOCrcv612.Checked)
      val += 1 << 1;
    if (chkOCrcv613.Checked)
      val += 1 << 2;
    if (chkOCrcv614.Checked)
      val += 1 << 3;
    if (chkOCrcv615.Checked)
      val += 1 << 4;
    if (chkOCrcv616.Checked)
      val += 1 << 5;
    if (chkOCrcv617.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv49_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv491.Checked)
      val += 1 << 0;
    if (chkOCrcv492.Checked)
      val += 1 << 1;
    if (chkOCrcv493.Checked)
      val += 1 << 2;
    if (chkOCrcv494.Checked)
      val += 1 << 3;
    if (chkOCrcv495.Checked)
      val += 1 << 4;
    if (chkOCrcv496.Checked)
      val += 1 << 5;
    if (chkOCrcv497.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv41_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv411.Checked)
      val += 1 << 0;
    if (chkOCrcv412.Checked)
      val += 1 << 1;
    if (chkOCrcv413.Checked)
      val += 1 << 2;
    if (chkOCrcv414.Checked)
      val += 1 << 3;
    if (chkOCrcv415.Checked)
      val += 1 << 4;
    if (chkOCrcv416.Checked)
      val += 1 << 5;
    if (chkOCrcv417.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv31_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv311.Checked)
      val += 1 << 0;
    if (chkOCrcv312.Checked)
      val += 1 << 1;
    if (chkOCrcv313.Checked)
      val += 1 << 2;
    if (chkOCrcv314.Checked)
      val += 1 << 3;
    if (chkOCrcv315.Checked)
      val += 1 << 4;
    if (chkOCrcv316.Checked)
      val += 1 << 5;
    if (chkOCrcv317.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv25_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv251.Checked)
      val += 1 << 0;
    if (chkOCrcv252.Checked)
      val += 1 << 1;
    if (chkOCrcv253.Checked)
      val += 1 << 2;
    if (chkOCrcv254.Checked)
      val += 1 << 3;
    if (chkOCrcv255.Checked)
      val += 1 << 4;
    if (chkOCrcv256.Checked)
      val += 1 << 5;
    if (chkOCrcv257.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv22_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv221.Checked)
      val += 1 << 0;
    if (chkOCrcv222.Checked)
      val += 1 << 1;
    if (chkOCrcv223.Checked)
      val += 1 << 2;
    if (chkOCrcv224.Checked)
      val += 1 << 3;
    if (chkOCrcv225.Checked)
      val += 1 << 4;
    if (chkOCrcv226.Checked)
      val += 1 << 5;
    if (chkOCrcv227.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv19_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv191.Checked)
      val += 1 << 0;
    if (chkOCrcv192.Checked)
      val += 1 << 1;
    if (chkOCrcv193.Checked)
      val += 1 << 2;
    if (chkOCrcv194.Checked)
      val += 1 << 3;
    if (chkOCrcv195.Checked)
      val += 1 << 4;
    if (chkOCrcv196.Checked)
      val += 1 << 5;
    if (chkOCrcv197.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv16_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv161.Checked)
      val += 1 << 0;
    if (chkOCrcv162.Checked)
      val += 1 << 1;
    if (chkOCrcv163.Checked)
      val += 1 << 2;
    if (chkOCrcv164.Checked)
      val += 1 << 3;
    if (chkOCrcv165.Checked)
      val += 1 << 4;
    if (chkOCrcv166.Checked)
      val += 1 << 5;
    if (chkOCrcv167.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv14_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv141.Checked)
      val += 1 << 0;
    if (chkOCrcv142.Checked)
      val += 1 << 1;
    if (chkOCrcv143.Checked)
      val += 1 << 2;
    if (chkOCrcv144.Checked)
      val += 1 << 3;
    if (chkOCrcv145.Checked)
      val += 1 << 4;
    if (chkOCrcv146.Checked)
      val += 1 << 5;
    if (chkOCrcv147.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv13_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv131.Checked)
      val += 1 << 0;
    if (chkOCrcv132.Checked)
      val += 1 << 1;
    if (chkOCrcv133.Checked)
      val += 1 << 2;
    if (chkOCrcv134.Checked)
      val += 1 << 3;
    if (chkOCrcv135.Checked)
      val += 1 << 4;
    if (chkOCrcv136.Checked)
      val += 1 << 5;
    if (chkOCrcv137.Checked)
      val += 1 << 6;
  ...
  private void chkOCrcv11_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCrcv111.Checked)
      val += 1 << 0;
    if (chkOCrcv112.Checked)
      val += 1 << 1;
    if (chkOCrcv113.Checked)
      val += 1 << 2;
    if (chkOCrcv114.Checked)
      val += 1 << 3;
    if (chkOCrcv115.Checked)
      val += 1 << 4;
    if (chkOCrcv116.Checked)
      val += 1 << 5;
    if (chkOCrcv117.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmitLMW_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmitLMW1.Checked)
      val += 1 << 0;
    if (chkOCxmitLMW2.Checked)
      val += 1 << 1;
    if (chkOCxmitLMW3.Checked)
      val += 1 << 2;
    if (chkOCxmitLMW4.Checked)
      val += 1 << 3;
    if (chkOCxmitLMW5.Checked)
      val += 1 << 4;
    if (chkOCxmitLMW6.Checked)
      val += 1 << 5;
    if (chkOCxmitLMW7.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit120_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit1201.Checked)
      val += 1 << 0;
    if (chkOCxmit1202.Checked)
      val += 1 << 1;
    if (chkOCxmit1203.Checked)
      val += 1 << 2;
    if (chkOCxmit1204.Checked)
      val += 1 << 3;
    if (chkOCxmit1205.Checked)
      val += 1 << 4;
    if (chkOCxmit1206.Checked)
      val += 1 << 5;
    if (chkOCxmit1207.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit90_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit901.Checked)
      val += 1 << 0;
    if (chkOCxmit902.Checked)
      val += 1 << 1;
    if (chkOCxmit903.Checked)
      val += 1 << 2;
    if (chkOCxmit904.Checked)
      val += 1 << 3;
    if (chkOCxmit905.Checked)
      val += 1 << 4;
    if (chkOCxmit906.Checked)
      val += 1 << 5;
    if (chkOCxmit907.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit61_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit611.Checked)
      val += 1 << 0;
    if (chkOCxmit612.Checked)
      val += 1 << 1;
    if (chkOCxmit613.Checked)
      val += 1 << 2;
    if (chkOCxmit614.Checked)
      val += 1 << 3;
    if (chkOCxmit615.Checked)
      val += 1 << 4;
    if (chkOCxmit616.Checked)
      val += 1 << 5;
    if (chkOCxmit617.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit49_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit491.Checked)
      val += 1 << 0;
    if (chkOCxmit492.Checked)
      val += 1 << 1;
    if (chkOCxmit493.Checked)
      val += 1 << 2;
    if (chkOCxmit494.Checked)
      val += 1 << 3;
    if (chkOCxmit495.Checked)
      val += 1 << 4;
    if (chkOCxmit496.Checked)
      val += 1 << 5;
    if (chkOCxmit497.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit41_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit411.Checked)
      val += 1 << 0;
    if (chkOCxmit412.Checked)
      val += 1 << 1;
    if (chkOCxmit413.Checked)
      val += 1 << 2;
    if (chkOCxmit414.Checked)
      val += 1 << 3;
    if (chkOCxmit415.Checked)
      val += 1 << 4;
    if (chkOCxmit416.Checked)
      val += 1 << 5;
    if (chkOCxmit417.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit31_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit311.Checked)
      val += 1 << 0;
    if (chkOCxmit312.Checked)
      val += 1 << 1;
    if (chkOCxmit313.Checked)
      val += 1 << 2;
    if (chkOCxmit314.Checked)
      val += 1 << 3;
    if (chkOCxmit315.Checked)
      val += 1 << 4;
    if (chkOCxmit316.Checked)
      val += 1 << 5;
    if (chkOCxmit317.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit25_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit251.Checked)
      val += 1 << 0;
    if (chkOCxmit252.Checked)
      val += 1 << 1;
    if (chkOCxmit253.Checked)
      val += 1 << 2;
    if (chkOCxmit254.Checked)
      val += 1 << 3;
    if (chkOCxmit255.Checked)
      val += 1 << 4;
    if (chkOCxmit256.Checked)
      val += 1 << 5;
    if (chkOCxmit257.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit22_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit221.Checked)
      val += 1 << 0;
    if (chkOCxmit222.Checked)
      val += 1 << 1;
    if (chkOCxmit223.Checked)
      val += 1 << 2;
    if (chkOCxmit224.Checked)
      val += 1 << 3;
    if (chkOCxmit225.Checked)
      val += 1 << 4;
    if (chkOCxmit226.Checked)
      val += 1 << 5;
    if (chkOCxmit227.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit19_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit191.Checked)
      val += 1 << 0;
    if (chkOCxmit192.Checked)
      val += 1 << 1;
    if (chkOCxmit193.Checked)
      val += 1 << 2;
    if (chkOCxmit194.Checked)
      val += 1 << 3;
    if (chkOCxmit195.Checked)
      val += 1 << 4;
    if (chkOCxmit196.Checked)
      val += 1 << 5;
    if (chkOCxmit197.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit16_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit161.Checked)
      val += 1 << 0;
    if (chkOCxmit162.Checked)
      val += 1 << 1;
    if (chkOCxmit163.Checked)
      val += 1 << 2;
    if (chkOCxmit164.Checked)
      val += 1 << 3;
    if (chkOCxmit165.Checked)
      val += 1 << 4;
    if (chkOCxmit166.Checked)
      val += 1 << 5;
    if (chkOCxmit167.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit14_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit141.Checked)
      val += 1 << 0;
    if (chkOCxmit142.Checked)
      val += 1 << 1;
    if (chkOCxmit143.Checked)
      val += 1 << 2;
    if (chkOCxmit144.Checked)
      val += 1 << 3;
    if (chkOCxmit145.Checked)
      val += 1 << 4;
    if (chkOCxmit146.Checked)
      val += 1 << 5;
    if (chkOCxmit147.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit13_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit131.Checked)
      val += 1 << 0;
    if (chkOCxmit132.Checked)
      val += 1 << 1;
    if (chkOCxmit133.Checked)
      val += 1 << 2;
    if (chkOCxmit134.Checked)
      val += 1 << 3;
    if (chkOCxmit135.Checked)
      val += 1 << 4;
    if (chkOCxmit136.Checked)
      val += 1 << 5;
    if (chkOCxmit137.Checked)
      val += 1 << 6;
  ...
  private void chkOCxmit11_CheckedChanged(object sender, EventArgs e) {
    int val = 0;
    if (chkOCxmit111.Checked)
      val += 1 << 0;
    if (chkOCxmit112.Checked)
      val += 1 << 1;
    if (chkOCxmit113.Checked)
      val += 1 << 2;
    if (chkOCxmit114.Checked)
      val += 1 << 3;
    if (chkOCxmit115.Checked)
      val += 1 << 4;
    if (chkOCxmit116.Checked)
      val += 1 << 5;
    if (chkOCxmit117.Checked)
      val += 1 << 6;
  ...
  public bool AlexHPFBypass {
    ...
    set {
      if (chkAlexHPFBypass != null)
        chkAlexHPFBypass.Checked = value;
    }
  }
  ...
  public bool Alex2HPFBypass {
    ...
    set {
      if (chkAlex2HPFBypass != null)
        chkAlex2HPFBypass.Checked = value;
    }
  }
  ...
  private void chkFullDiscovery_CheckedChanged(object sender, EventArgs e) {
    if (chkFullDiscovery.Checked)
      chkEnableStaticIP.Checked = false;
  ...
  private void tbDisplayFFTSize_Scroll(object sender, EventArgs e) {
    console.specRX.GetSpecRX(0).FFTSize =
        (int)(4096 * Math.Pow(2, Math.Floor((double)(tbDisplayFFTSize.Value))));
  ...
  private void tbRX2DisplayFFTSize_Scroll(object sender, EventArgs e) {
    ...
    // Math.Floor((double)(tbDisplayFFTSize.Value))));
    console.specRX.GetSpecRX(1).FFTSize =
        (int)(4096 * Math.Pow(2, Math.Floor((double)(tbRX2DisplayFFTSize.Value))));
  ...
  private void chkDSPRX2APFEnable_CheckedChanged(object sender, EventArgs e) {
    if (console.RX2DSPMode == DSPMode.CWL || console.RX2DSPMode == DSPMode.CWU)
...
#region MultiNotchFilter
  ...
  public bool NotchAdminBusy {
    ...
    get { return AddActive | EditActive; }
  }
  ...
  private void btnMNFEnter_Click(object sender, EventArgs e) {
    if (AddActive) {
      ...
      WDSP.RXANBPAddNotch(WDSP.id(0, 0), (int)udMNFNotch.Value, 1.0e6 * (double)udMNFFreq.Value,
                          (double)udMNFWidth.Value, chkMNFActive.Checked);
      WDSP.RXANBPAddNotch(WDSP.id(0, 1), (int)udMNFNotch.Value, 1.0e6 * (double)udMNFFreq.Value,
                          (double)udMNFWidth.Value, chkMNFActive.Checked);
      WDSP.RXANBPAddNotch(WDSP.id(2, 0), (int)udMNFNotch.Value, 1.0e6 * (double)udMNFFreq.Value,
                          (double)udMNFWidth.Value, chkMNFActive.Checked);
    ...
    if (EditActive) {
      ...
      udMNFWidth.BackColor = SystemColors.Control;
      chkMNFActive.BackColor = SystemColors.Control;
      WDSP.RXANBPEditNotch(WDSP.id(0, 0), (int)udMNFNotch.Value, 1.0e6 * (double)udMNFFreq.Value,
                           (double)udMNFWidth.Value, chkMNFActive.Checked);
      WDSP.RXANBPEditNotch(WDSP.id(0, 1), (int)udMNFNotch.Value, 1.0e6 * (double)udMNFFreq.Value,
                           (double)udMNFWidth.Value, chkMNFActive.Checked);
      WDSP.RXANBPEditNotch(WDSP.id(2, 0), (int)udMNFNotch.Value, 1.0e6 * (double)udMNFFreq.Value,
                           (double)udMNFWidth.Value, chkMNFActive.Checked);
    }
  ...
  private void tbTXDisplayFFTSize_Scroll(object sender, EventArgs e) {
    console.specRX.GetSpecRX(cmaster.inid(1, 0)).FFTSize =
        (int)(4096 * Math.Pow(2, Math.Floor((double)(tbTXDisplayFFTSize.Value))));
    console.UpdateTXSpectrumDisplayVars();
    double bin_width = (double)console.specRX.GetSpecRX(cmaster.inid(1, 0)).SampleRate /
  ...
  private void lblVAC1ovfl_Click(object sender, EventArgs e) { ivac.resetIVACdiags(0, 0); }

  private void lblVAC1unfl_Click(object sender, EventArgs e) { ivac.resetIVACdiags(0, 0); }

  private void lblVAC1ovfl2_Click(object sender, EventArgs e) { ivac.resetIVACdiags(0, 1); }

  private void lblVAC1unfl2_Click(object sender, EventArgs e) { ivac.resetIVACdiags(0, 1); }

  private void lblVAC2ovfl_Click(object sender, EventArgs e) { ivac.resetIVACdiags(1, 0); }

  private void lblVAC2unfl_Click(object sender, EventArgs e) { ivac.resetIVACdiags(1, 0); }

  private void lblVAC2ovfl2_Click(object sender, EventArgs e) { ivac.resetIVACdiags(1, 1); }

  private void lblVAC2unfl2_Click(object sender, EventArgs e) { ivac.resetIVACdiags(1, 1); }
  ...
  private void udUpdatesPerStepMax_ValueChanged(object sender, EventArgs e) {
    ...
    if (selectedMax <= currMin)
      udUpdatesPerStepMin.Value =
          selectedMax - 1; // keep min and max sensible and separated by at least 1
  ...
  private void udUpdatesPerStepMin_ValueChanged(object sender, EventArgs e) {
    ...
    if (selectedMin >= currMax)
      udUpdatesPerStepMax.Value =
          selectedMin + 1; // keep min and max sensible and separated by at least 1
  ...
  private void ComboHIDMouseWheel_SelectedIndexChanged(object sender, EventArgs e) {
    if (!(comboHIDMouseWheel.SelectedItem is HIDComboItem))
      return;
...
#region RawInput WIP
  ...
  private void btnShowSeqLog_Click(object sender, EventArgs e) { console.ShowSEQLog(); }
  ...
  private void clrbtnSignalHistoryColour_Changed(object sender, EventArgs e) {
    console.SignalHistoryColour =
        Color.FromArgb(tbSignalHistoryAlpha.Value, clrbtnSignalHistoryColour.Color);
  }
  ...
  private void ButtonAndromeda_Click(object sender, EventArgs e) { console.EditAndromedaDataSet(); }
  ...
  private void ChkEnableGanymede_CheckedChanged(object sender, EventArgs e) {
    ...
    if (comboGanymedeCATPort.Text == "" || !comboGanymedeCATPort.Text.StartsWith("COM")) {
      if (chkEnableGanymede.Focused) {
        if (chkEnableGanymede.Checked) {
          MessageBox.Show("The CAT port \"" + comboGanymedeCATPort.Text +
                          "\" is not a valid port.\n" + "Please select another port.");
          chkEnableGanymede.Checked = false;
        }
      }
    ...
    if (chkEnableGanymede.Checked && console.PTTBitBangEnabled &&
      ...
      MessageBox.Show("Ganymede CAT port cannot be the same as Bit Bang Port",
                      "Port Selection Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
      chkEnableGanymede.Checked = false;
    }
  ...
  private void BtnAriesErase1_Click(object sender, EventArgs e) { console.AriesErasePressed(1); }

  private void BtnAriesErase2_Click(object sender, EventArgs e) { console.AriesErasePressed(2); }

  private void BtnAriesErase3_Click(object sender, EventArgs e) { console.AriesErasePressed(3); }
  ...
  private void udQSOTimerMinutes_ValueChanged(object sender, EventArgs e) { setQSOTimerDuration(); }

  private void udQSOTimerSeconds_ValueChanged(object sender, EventArgs e) { setQSOTimerDuration(); }
  ...
  private void chkQSOTimerResetOnExpiry_CheckedChanged(object sender, EventArgs e) {
    ...
    chkQSOTimerFlashTimerIfResetOnExpiry.Enabled =
        chkQSOTimerResetOnExpiry.Enabled && chkQSOTimerResetOnExpiry.Checked;
  ...
  public void applyVACSettings(vacinfo info, ApplyVACFlags flags = ApplyVACFlags.All) {
    try {
      ...
      MessageBox.Show(
          ...
          "Re-Applying current VAC settings Failed", MessageBoxButtons.OK, MessageBoxIcon.Error);
    }
  }
