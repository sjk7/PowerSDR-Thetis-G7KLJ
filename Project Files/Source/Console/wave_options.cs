...
#region Windows Form Designer generated code
  ...
  private void InitializeComponent() {
    ...
    this.comboSampleRate.Items.AddRange(new object[] { "6000", "12000", "24000", "48000", "96000",
                                                       "192000", "384000", "768000", "1536000" });
    ...
    this.toolTip1.SetToolTip(this.comboSampleRate,
                             "Sample Rate -- Range is dependent on selected sound card! ");
    //
    // radTXPostProcessed
    //
    ...
    this.toolTip1.SetToolTip(this.radTXPostProcessed,
                             "Transmitter I/Q data outbound to the hardware.");
    this.radTXPostProcessed.CheckedChanged +=
        new System.EventHandler(this.radTXPostProcessed_CheckedChanged);
    //
    // radTXPreProcessed
    //
    ...
    this.toolTip1.SetToolTip(this.radTXPreProcessed,
                             "Raw MIC Audio Input coming from the hardware.");
    this.radTXPreProcessed.CheckedChanged +=
        new System.EventHandler(this.radTXPreProcessed_CheckedChanged);
    //
    // radRXPostProcessed
    //
    ...
    this.toolTip1.SetToolTip(this.radRXPostProcessed,
                             "The demodulated filtered audio you listen to.");
    this.radRXPostProcessed.CheckedChanged +=
        new System.EventHandler(this.radRXPostProcessed_CheckedChanged);
    //
    // radRXPreProcessed
    //
    ...
    this.radRXPreProcessed.CheckedChanged +=
        new System.EventHandler(this.radRXPreProcessed_CheckedChanged);
    //
    // grpWaveDither
    //
    ...
    this.udWaveDitherBits.Increment = new decimal(new int[] { 1, 0, 0, 65536 });
    this.udWaveDitherBits.Location = new System.Drawing.Point(6, 41);
    this.udWaveDitherBits.Maximum = new decimal(new int[] { 10, 0, 0, 65536 });
    this.udWaveDitherBits.Minimum = new decimal(new int[] { 1, 0, 0, 65536 });
    ...
    this.udWaveDitherBits.Value = new decimal(new int[] { 8, 0, 0, 65536 });
    //
    // grpBitDepth
    //
    ...
    this.radBitDepth8PCM.CheckedChanged +=
        new System.EventHandler(this.radBitDepth8PCM_CheckedChanged);
    //
    // radBitDepth16PCM
    //
    ...
    this.radBitDepth16PCM.CheckedChanged +=
        new System.EventHandler(this.radBitDepth16PCM_CheckedChanged);
    //
    // radBitDepth24PCM
    //
    ...
    this.radBitDepth24PCM.CheckedChanged +=
        new System.EventHandler(this.radBitDepth24PCM_CheckedChanged);
    //
    // radBitDepth32PCM
    //
    ...
    this.radBitDepth32PCM.CheckedChanged +=
        new System.EventHandler(this.radBitDepth32PCM_CheckedChanged);
    //
    // radBitDepthIEEE
    //
    ...
    this.radBitDepthIEEE.CheckedChanged +=
        new System.EventHandler(this.radBitDepthIEEE_CheckedChanged);
    //
    // grpAudioSampleRate1
    //
