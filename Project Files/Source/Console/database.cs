...
//    USA
//=================================================================
// Modifications to the database import function to allow using files created
// with earlier versions. by Chris Codella, W2PA, May 2017.  Indicated by
// //-W2PA comment lines.
...
#region Private Member Functions
    ...
    private static void VerifyTables() {
        if (!ds.Tables.Contains("BandText")) AddBandTextTable();
        ...
        if (!ds.Tables.Contains("Memory")) AddMemoryTable();

        if (!ds.Tables.Contains("GroupList")) AddGroupListTable();

        if (!ds.Tables.Contains("TXProfile")) AddTXProfileTable("TXProfile");
    ...
    private static void AddBandTextTable() {
        ...
        object[] data = {
            ...
            432.100001,
            432.299999,
            "70cm Mixed Mode Weak Signal",
            true,
            432.300000,
            432.399999,
            "70cm Propagation Beacons",
            true,
            432.400000,
            432.999999,
            "70cm Mixed Mode Weak Signal",
            ...
            902.000000,
            902.099999,
            "33cm Weak Signal SSTV/FAX/ACSSB",
            true,
            902.100000,
            902.100000,
            "33cm Weak Signal Calling",
            true,
            902.100001,
            902.799999,
            "33cm Weak Signal SSTV/FAX/ACSSB",
            ...
            1260.000000,
            1269.999999,
            "23cm Sat Uplinks/Wideband Exp.",
            true,
            1270.000000,
            1275.999999,
            "23cm Repeater Inputs",
            true,
            1276.000000,
            1281.999999,
            "23cm ATV #3",
            ...
            1282.000000,
            1287.999999,
            "23cm Repeater Outputs",
            true,
            1288.000000,
            1293.999999,
            "23cm Simplex ATV/Wideband Exp.",
            true,
            1294.000000,
            1294.499999,
            "23cm Simplex FM",
            ...
            1295.000000,
            1295.799999,
            "23cm SSTV/FAX/ACSSB/Exp.",
            true,
            1295.800000,
            1295.999999,
            "23cm EME/CW Expansion",
            true,
            1296.000000,
            1296.049999,
            "23cm EME Exclusive",
            ...
            1296.400000,
            1296.599999,
            "23cm X-Band Translator Input",
            true,
            1296.600000,
            1296.799999,
            "23cm X-Band Translator Output",
            true,
            1296.800000,
            1296.999999,
            "23cm Experimental Beacons",
            true,
            1297.000000,
            1300.000000,
            "23cm Digital Modes",
            ...
            2304.200000,
            2304.299999,
            "2.3GHz SSB/SSTV/FAX/Packet AM/Amtor",
            true,
            2304.300000,
            2304.319999,
            "2.3GHz Propagation Beacon Network",
            true,
            2304.320000,
            2304.399999,
            "2.3GHz General Propagation Beacons",
            true,
            2304.400000,
            2304.499999,
            "2.3GHz SSB/SSTV/ACSSB/FAX/Packet AM",
            true,
            2304.500000,
            2304.699999,
            "2.3GHz X-Band Translator Input",
            true,
            2304.700000,
            2304.899999,
            "2.3GHz X-Band Translator Output",
            true,
            2304.900000,
            2304.999999,
            "2.3GHz Experimental Beacons",
            true,
            2305.000000,
            2305.199999,
            "2.3GHz FM Simplex",
            ...
            2403.000000,
            2407.999999,
            "2.4GHz Satellite High-Rate Data",
            true,
            2408.000000,
            2409.999999,
            "2.4GHz Satellite",
            ...
            2433.000000,
            2437.999999,
            "2.4GHz Sat. High-Rate Data",
            true,
            2438.000000,
            2450.000000,
            "2.4GHz Wideband FM/FSTV/FMTV",
            true,
    ...
    private static void AddRegionJapanBandText() {
        ...
        object[] data = {
            ...
            28.200001,
            28.999999,
            "10M CW/SSB/RTTY/SSTV",
            true,
            29.000000,
            29.299999,
            "10M FM/RTTY/SSTV/DATA",
            true,
            29.300000,
            29.509999,
            "10M Satellite Downlinks",
    ...
    private static void AddRegion1BandText160m() {
        ...
        object[] data = {
            ...
            1.838000,
            1.839999,
            "160M Narrow Band Modes",
            true,
            1.840000,
            1.842999,
            "160M All Modes & Digital",
            true,
            1.843000,
            1.999999,
            "160M All Modes & Digital",
    ...
    private static void AddRegion1BandText15m() {
        ...
        object[] data = {
            ...
            21.070000,
            21.109999,
            "15M Narrow Band Modes",
            true,
            21.110000,
            21.119999,
            "15M Wide Band Digital",
            true,
            21.120000,
            21.148999,
            "15M Narrow Band Modes",
    ...
    private static void AddRegion1BandText10m() {
        ...
        object[] data = {
            ...
            28.225000,
            28.299999,
            "10M All Mode Beacons",
            true,
            28.300000,
            28.319999,
            "10M All Mode Digital",
            true,
            28.320001,
            28.329999,
            "10M All Modes",
    ...
    private static void AddRegionIsraelBandText160m() {
        ...
        object[] data = {
            ...
            1.838000,
            1.839999,
            "160M Digital/Packet/CW",
            true,
            1.840000,
            1.842999,
            "160M Digital/Packet/CW/SSB",
            true,
            1.843000,
            1.999999,
            "160M SSB/CW",
    ...
    private static void AddRegionIsraelBandText40m() {
        ...
        object[] data = {
            ...
            7.035000,
            7.040000,
            "40M Digital/SSTV/FAX/CW",
            true,
            7.040001,
            7.044999,
            "40M Digital/SSTV/FAX/CW/SSB",
            true,
            7.045000,
            7.199999,
            "40M SSB/CW",
    ...
    private static void AddRegionIsraelBandText20m() {
        ...
        object[] data = {
            ...
            14.089000,
            14.098999,
            "20M Digital(Non-Auto Packet)/CW",
            true,
            14.099000,
            14.100999,
            "20M Beacons",
    ...
    private static void AddRegionIsraelBandText10m() {
        ...
        object[] data = {
            ...
            28.190000,
            28.198999,
            "10M Regional Beacons",
            true,
            28.199000,
            28.200999,
            "10M World Wide Beacons",
            true,
            28.201000,
            28.224999,
            "10M Continous-Duty Beacons",
            true,
            28.225000,
            28.679999,
            "10M SSB/CW",
    ...
    private static void AddRegion1BandTextVHFplus() {
        ...
        object[] data = {
            ...
            430.600000,
            430.924999,
            "70cm FM Digital Repeater",
            true,
            430.925000,
            431.024999,
            "70cm Multimode Channels",
            true,
            431.025000,
            431.049999,
            "70cm Sub-Regional",
            ...
            3400.000000,
            3400.099999,
            "9cm Narrow Band Modes",
            true,
            3400.100000,
            3400.100000,
            "9cm Narrow Band Calling",
            true,
            3400.100001,
            3401.999999,
            "9cm Narrow Band Modes",
            ...
            5650.000000,
            5667.999999,
            "5cm Satellite Uplink",
            true,
            5668.000000,
            5668.199999,
            "5cm Sat Uplink/Narrow Band",
            true,
            5668.200000,
            5668.200000,
            "5cm Narrow Band calling",
            true,
            5668.200001,
            5669.999999,
            "5cm Sat Uplink/Narrow Band",
            ...
            10368.000000,
            10368.199999,
            "3cm Narrow Band Modes",
            true,
            10368.200000,
            10368.200000,
            "3cm Narrow Band Calling",
            true,
            10368.200001,
            10369.999999,
            "3cm Narrow Band Modes",
            ...
            24048.000000,
            24048.199999,
            "1.2cm Narrow Band Modes",
            true,
            24048.200000,
            24048.200000,
            "1.2cm Narrow Band Calling",
            true,
            24048.200001,
            24049.999999,
            "1.2cm Narrow Band",
    ...
    private static void AddSwedenBandText60m() {
        ...
        object[] data = { 5.250000, 5.309999, "60M Band", false, 5.310000,
            5.313000, "60M Band Segment 1", true, 5.313001, 5.319999,
            "60M Band", false, 5.320000, 5.323000, "60M Band Segment 2", true,
            5.323001, 5.379999, "60M Band", false, 5.380000, 5.383000,
            "60M Band Segment 3", true, 5.383001, 5.389999, "60M Band", false,
            5.390000, 5.393000, "60M Band Segment 4", true, 5.393001, 5.449999,
            "60M Band", false };
...
#region IARU Region 3 BandText
    ...
    private static void AddRegion3BandText6m() {
        ...
        object[] data = {
            ...
            50.100000,
            50.499999,
            "6M Phone/NB Digital/CW",
            true,
            50.500000,
            53.999999,
            "6M Wide Band Modes & CW",
            true,
        };
    ...
    private static void AddRegion3BandTextVHFplus() {
        ...
        object[] data = {
            ...
            144.400000,
            144.499999,
            "2M CW/Phone/NB Digital",
            true,
            144.500000,
            144.699999,
            "2M Wide Digital Modes",
            true,
            144.700000,
            145.499999,
            "2M FM, CW & Image",
            ...
            430.700000,
            430.799999,
            "70cm CW/Phone/NB Digital",
            true,
            430.800000,
            431.399999,
            "70cm Wide Digital Modes",
            true,
            431.400000,
            431.899999,
            "70cm FM, CW & Image",
    ...
    private static void AddJapanBandText80m() {
        ...
        object[] data = {
            ...
            3.525001,
            3.529999,
            "80M Phone/CW/NB Digital",
            true,
            3.530000,
            3.574999,
            "80M Phone/CW/Digital",
            true,
            3.575000,
            3.598999,
            "80M Band RX",
    ...
    private static void AddJapanBandText10m() {
        ...
        object[] data = {
            ...
            28.200501,
            28.999999,
            "10M Phone/CW/NB Digital",
            true,
            29.000000,
            29.299999,
            "10M DX Phone/CW/Digital",
            true,
            29.300000,
            29.509999,
            "10M Satellite",
    ...
    private static void AddJapanBandText6m() {
        ...
        object[] data = {
            ...
            50.900000,
            50.999999,
            "6M Phone/CW/NB Digital",
            true,
            51.100000,
            51.999999,
            "6M Wide Phone/Image/CW",
            true,
            52.000000,
            52.499999,
            "6M Phone/CW/NB Digital",
    ...
    private static void AddTXProfileTable(
        string sTableName, bool bIndcludeExtraProfiles = false) {
...
#region AM 10k CFC
    ...
    private static void CheckBandTextValid() {
        ...
        foreach (DataRow dr in ds.Tables["BandText"].Rows) {
            ...
            f = f.Replace(",", ".");
            DataRow[] rows
                = ds.Tables["BandText"].Select(f + ">=Low AND " + f + "<=High");
            if (rows.Length > 1) {
                // handle multiple entries
                if (!bad_rows.Contains(dr)) bad_rows.Add(dr);
            }
        ...
        foreach (DataRow dr in bad_rows) ds.Tables["BandText"].Rows.Remove(dr);
    }
...
#region Public Member Functions
    ...
    public static void Update() {
        try {
            ds.WriteXml(m_file_name, XmlWriteMode.WriteSchema);
        } catch (Exception ex) {
            MessageBox.Show("A database write to file operation failed.  "
                    + "The exception error was:\n\n" + ex.Message,
                "ERROR: Database Write Error", MessageBoxButtons.OK,
    ...
    public static bool BandText(double freq, out string outStr) {
        try {
            ...
            {
                MessageBox.Show("Error reading BandInfo table.",
    ...
    public static int[] GetBandStackNum() {
        string[] band_list
            = { "160M", "80M", "60M", "40M", "30M", "20M", "17M", "15M", "12M",
                  "10M", "6M", "2M", "WWV", "GEN", "LMF", "120M", "90M", "61M",
                  "49M", "41M", "31M", "25M", "22M", "19M", "16M", "14M", "13M",
                  "11M", "VHF0", "VHF1", "VHF2", "VHF3", "VHF4", "VHF5", "VHF6",
                  "VHF7", "VHF8", "VHF9", "VHF10", "VHF11", "VHF12", "VHF13" };
        ...
        for (int i = 0; i < band_list.Length; i++) {
            ...
            DataRow[] rows
                = ds.Tables["BandStack"].Select("'" + s + "' = BandName");
    ...
    public static bool GetBandStack(string band, int index, out string mode,
        out string filter, out double freq, out bool CTUN, out int ZoomFactor,
        out double CenterFreq) {
        DataRow[] rows
            = ds.Tables["BandStack"].Select("'" + band + "' = BandName");

        if (rows.Length == 0) {
            MessageBox.Show("No Entries found for Band: " + band,
                "No Entry Found", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            mode = "";
            filter = "";
            freq = 0.0f;
            CTUN = false;
    ...
    public static void AddBandStack(string band, string mode, string filter,
        double freq, bool CTUN, int ZoomFactor, double CenterFreq) {
        DataRow dr = ds.Tables["BandStack"].NewRow();
        dr["BandName"] = band;
        dr["Mode"] = mode;
        dr["Filter"] = filter;
    ...
    public static void SaveBandStack(string band, int index, string mode,
        string filter, double freq, bool CTUN, int ZoomFactor,
        double CenterFreq) {
        DataRow[] rows
            = ds.Tables["BandStack"].Select("'" + band + "' = BandName");
    ...
    //==================================================================================================
    // ke9ns add to delete the current bandstack entry (passed from stack.cs to
    // console.cs)
    public static void PurgeBandStack(
        int index, string band, string mode, string filter, string freq2) {

        if (!ds.Tables.Contains("BandStack"))
            return; // dont run in no bandstack data

        string temp = "Freq = '" + freq2 + "'";

        try {
            DataRow[] rows = ds.Tables["BandStack"].Select(
                temp); // find the identical freq in the bandstack
            ...
            MessageBox.Show("No Entries found to Delete for Band: " + band,
                "No Entry Found", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
    ...
    //====================================================================================================
    // ke9ns add  allows bubble sort routine in stack.cs to update bandstack
    // without checking for dups
    public static void SortBandStack(string band, int index, string mode,
        string filter, double freq, bool CTUN, int ZoomFactor,
        double CenterFreq) {
        try {
            ...
            MessageBox.Show("problem found sorting entry for Band: " + band,
                "No Entry Found", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        }
    ...
    //==================================================================================================
    // ke9ns add
    public static void AddBandText(
        double freq, double freq1, string name, bool tx) {
    ...
    // This removes the notches from the state database so we can rewrite all of
    // them without having one that was previously deleted staying in the
    // database
    ...
    public static void SaveVars(string tableName, ref ArrayList list) {
        ...
        foreach (string s in list) {
            ...
            // MW0LGE converted to Rows.Find because it is insanely faster,
            // needs a primary key though
            DataRow r = null;
            try {
                r = ds.Tables[tableName].Rows.Find(vals[0]);
            } catch (Exception) {
                System.Diagnostics.Debug.WriteLine(
                    "Error finding Datarow" + vals[0]);
            }
            if (r != null) {
                r[1] = vals[1];
            } else {
    ...
    public static ArrayList GetVars(string tableName) {
        ...
        if (!ds.Tables.Contains(tableName)) return list;
    ...
    //-W2PA New version of ImportDatabase to merge an old database or partly
    //corruped one with a new default one
    public static bool ImportAndMergeDatabase(
        string filename, string appDataPath) {
        string _versionnumber = "";

        importedDS = false;
        if (!File.Exists(filename)) return false;

        bool DBdebug = false; // Set =true to write various versions of the xml
                              // file during testing
        ...
        // Start by merging any tables in the imported DB that don't come with a
        ...
        foreach (DataTable table in existingDB.Tables) {
            ...
            switch (table.TableName) {
                    //------Uncomment this section to allow importing BandText
                    //rows from old db, and also comment out duplicate case
                    //below case "BandText":
                    ...
                    //    // For each row of existingDB, if there is matching
                    //    Low and High in oldDB,
                    //    // copy that entry, else take existing one, into
                    //    tempMergedTable. foreach (DataRow row in table.Rows)
                    //    {
                    //        string selector = "Low = " + row["Low"] + " AND
                    //        High = " + row["High"]; DataRow[] foundRow =
                    //        tempTable.Select(selector); if (foundRow.Length !=
                    //        0) tempMergedTable.ImportRow(foundRow[0]); else
                    //        tempMergedTable.ImportRow(row);
                    //    }

                    //    // Copy tempTable into mergedDB
                    //    mergedDB.Merge(tempMergedTable);
                    //    WriteImportLog(logFN, "Imported table <" +
                    //    table.TableName + "> into database.\n") break;
                ...
                case "BandStack":
                    ...
                    if (!foundTable) {
                        WriteImportLog(logFN,
                            "Did not import table <" + table.TableName
                                + "> into database. None found.\n");
                        break;
                    }

                    // For each row of existingDB, if there is a matching
                    // BandName in oldDB, copy those entries, else take existing
                    // ones, into tempMergedTable.
                    string bandName = "";
                    foreach (DataRow row in table.Rows) {
                        if (Convert.ToString(row["Bandname"])
                            != bandName) // haven't seen this band yet (do each
                                         // band only once)
                        {
                            bandName = Convert.ToString(row["BandName"]);
                            string selector = "BandName = \'" + bandName + "\'";
                            DataRow[] foundRowsOld = tempTable.Select(selector);
                            DataRow[] foundRowsExisting
                            ...
                            for (int i = foundRowsOld.Length;
                                 i < foundRowsExisting.Length;
                                 i++) // Pad with more rows if the new version
                                      // has more band stack rows
                            {
                    ...
                    mergedDB.Merge(tempMergedTable);
                    WriteImportLog(logFN,
                        "Imported table <" + table.TableName
                            + "> into database.\n");
                    break;
                case "BandText":
                // case "BandStack":
                case "GroupList":
                case "Memory":
                    mergedDB.Merge(table); // don't overwrite current tables for
                                           // these cases
                    WriteImportLog(logFN,
                        "Did not import table <" + table.TableName
                            + "> into database.\n");
                ...
                case "TXProfile":
                    ...
                    if (tT != null)
                        tempMergedTable.Merge(tT);
                    else {
                        tempMergedTable.Merge(table);
                        break;
                    } // No default model exists so reject the old TXProfiles

                    // For each row of existingDB, if there is matching key in
                    // oldDB, keep that entry, else import new existing one into
                    // tempMergedTable.
                    foreach (DataRow row in table.Rows) {
                        string selector = "Name = '" + row["Name"] + "'";
                        DataRow[] foundRow = tempMergedTable.Select(selector);
                        if (foundRow.Length == 0)
                            tempMergedTable.ImportRow(
                                row); // If not in the oldDB, take the new one
                    }
                ...
                case "TXProfileDef":
                    mergedDB.Merge(
                        table); // don't overwrite current table of defaults
                    WriteImportLog(logFN,
                        "Did not import table <" + table.TableName
                            + "> into database.\n");
                    break;

                // These tables all have Key/Value pairs so can all be processed
                // the same way
                case "State":
                case "Options":
                case "EQForm":
                ...
                case "PureSignal":
                    ...
                    if (!foundTable) {
                        // No corresponding table found in old database - must
                        // be new, so retain it as-is
                        mergedDB.Merge(table);
                        WriteImportLog(logFN,
                            "New table not found in imported database: "
                                + table.TableName + "\n");
                        break;
                    }

                    // For each row of existingDB table, if there is matching
                    // key in corresponding oldDB table, copy that entry, else
                    // take the existing one, into tempMergedTable.
                    foreach (DataRow row in table.Rows) {
                        string thisKey = Convert.ToString(row["Key"]);
                        if (thisKey
                            == "VersionNumber") // Exception: don't overwrite
                                                // version number with an old
                                                // one
                        {
                            ...
                            tempMergedTable.ImportRow(row);
                        } else if (thisKey.Contains(
                                       "_by_band")) // Exception: expand an old
                                                    // per-band string into a
                                                    // new, longer one
                        {
                            ...
                            if (foundRow.Length != 0) {
                                ...
                                string oldSettingsValue
                                    = Convert.ToString(oldSettingsRow["Value"]);
                                string newSettingsValue = oldSettingsValue;
                                int newSettingsLength
                                    = (Convert.ToString(
                                           newSettingsRow["Value"]))
                                          .Length;
                                string paddingDefault = "|"
                                    + oldSettingsValue[oldSettingsValue.Length
                                        - 1];
                                for (int i = (oldSettingsValue.Length);
                                     i < newSettingsLength;
                                     i += 2) // if new length is shorter, do
                                             // nothing
                                    newSettingsValue
                                        += paddingDefault; // expand old string
                                                           // into larger new
                                                           // string
                                ...
                                tempMergedTable.ImportRow(row);
                        } else if (thisKey == "comboRadioModel"
                            && String.Compare(_versionnumber, "2.7.0") < 0) {
                            // MW0LGE this db contains comboRadioModel, we need
                            // to pull over old radio selection from radio
                            // button implementation but only if exists. This
                            // will always run even if db being imported does
                            // not contain these rad button setting, and ideally
                            // should only happen if previous verison < 2.7.0.
                            // TODO?
                            string sRad = "";
                            if (getRadioSelectedFromOldRadButton(
                                    ref tempTable, "radGenModelHPSDR"))
                                sRad = "HPSDR";
                            else if (getRadioSelectedFromOldRadButton(
                                         ref tempTable, "radGenModelHermes"))
                                sRad = "HERMES";
                            else if (getRadioSelectedFromOldRadButton(
                                         ref tempTable, "radGenModelANAN10"))
                                sRad = "ANAN-10";
                            else if (getRadioSelectedFromOldRadButton(
                                         ref tempTable, "radGenModelANAN10E"))
                                sRad = "ANAN-10E";
                            else if (getRadioSelectedFromOldRadButton(
                                         ref tempTable, "radGenModelANAN100"))
                                sRad = "ANAN-100";
                            else if (getRadioSelectedFromOldRadButton(
                                         ref tempTable, "radGenModelANAN100B"))
                                sRad = "ANAN-100B";
                            else if (getRadioSelectedFromOldRadButton(
                                         ref tempTable, "radGenModelANAN100D"))
                                sRad = "ANAN-100D";
                            else if (getRadioSelectedFromOldRadButton(
                                         ref tempTable, "radGenModelANAN200D"))
                                sRad = "ANAN-200D";
                            else if (getRadioSelectedFromOldRadButton(
                                         ref tempTable, "radGenModelANAN7000D"))
                                sRad = "ANAN-7000DLE";
                            else if (getRadioSelectedFromOldRadButton(
                                         ref tempTable, "radGenModelANAN8000D"))
                                sRad = "ANAN-8000DLE";
                            // else if (getRadioSelectedFromOldRadButton(ref
                            // tempTable, "radGenModelORIONMKII")) sRad = ""; //
                            // not implemented in comboRadioModel list items

                            if (sRad
                                != "") // a radio has been previously selected
                            {
                                // Debug.Print("** FOUND OLD RADIO SETTING : " +
                                // sRad);
                                row["Value"] = sRad;
                                tempMergedTable.ImportRow(row);
                            } else
                ...
                default:
                    // Unrecognized table
                    WriteImportLog(
                        logFN, "Unrecognized table: " + table.TableName + "\n");
                    break;
            }
        }
        ...
        WriteImportLog(logFN, "\nImport succeeded.\n");
        importedDS
            = true; // Prevents overwriting the new database file on next exit
        return true;
    }

    //--MW0LGE
    private static bool getRadioSelectedFromOldRadButton(
        ref DataTable tempTable, string sRadButtonName) {
        // returns true if radbuttonname passed exists in old db and has a
        // setting of true
        bool bRet = false;
        DataRow oldSettingsRow;
    ...
    private static string ValidateImportedDatabase(DataSet oldDB) {
        ...
        if (oldDB.HasErrors || oldDB.DataSetName != "Data"
            || !oldDB.IsInitialized || oldDB.Tables.Count == 0) {
            // For debugging:
            problems = problems + "Invalid database read. \n\n"
    ...
    private static DataTable ExpandOldTxProfileTable(DataTable oldTable) {
        ...
        foreach (DataRow OldRow in oldTable.Rows) {
            ...
            foreach (DataColumn col in oldTable
                         .Columns) // Overwrite the subset of columns that were
                                   // in the old table
            {
                if ((ds.Tables["TXProfile"].Columns)
                        .Contains(
    ...
    public static bool ImportDatabase(string filename) {
        ...
        foreach (DataRow dr in rows) dr["Mode"] = "FM";
