...
typedef struct _syncb {
    void (*exf)(
        void); // pointer to function to execute after output buffer is filled
    ...
    int r1_outsize; // number of complex samples taken out of the ring for
                    // processing
...
extern SYNCB create_syncbuffs(int accept, int nstreams, int max_insize,
