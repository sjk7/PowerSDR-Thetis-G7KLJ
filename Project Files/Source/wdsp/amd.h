...
extern AMD create_amd(int run, int buff_size, double* in_buff, double* out_buff,
...
extern __declspec(dllexport) void SetRXAAMDFadeLevel(
    int channel, int levelfade);
