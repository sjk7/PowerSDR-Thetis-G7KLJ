...
extern WCPAGC create_wcpagc(int run, int mode, int pmode, double* in,
    double* out, int io_buffsize, int sample_rate, double tau_attack,
    double tau_decay, int n_tau, double max_gain, double var_gain,
    double fixed_gain, double max_input, double out_targ,
    double tau_fast_backaverage, double tau_fast_decay, double pop_ratio,
    int hang_enable, double tau_hang_backmult, double hangtime,
    double hang_thresh, double tau_hang_decay);
...
extern AGCPORT void SetRXAAGCThresh(
    int channel, double thresh, double size, double rate);

extern AGCPORT void GetRXAAGCThresh(
    int channel, double* thresh, double size, double rate);
