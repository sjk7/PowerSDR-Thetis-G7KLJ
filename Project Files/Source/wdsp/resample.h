...
__declspec(dllexport) RESAMPLE create_resample(int run, int size, double* in,
    double* out, int in_rate, int out_rate, double fc, int ncoef, double gain);

__declspec(dllexport) void destroy_resample(RESAMPLE a);

__declspec(dllexport) void flush_resample(RESAMPLE a);
...
extern RESAMPLEF create_resampleF(
