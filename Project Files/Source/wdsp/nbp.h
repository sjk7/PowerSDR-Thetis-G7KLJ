...
extern NBP create_nbp(int run, int fnfrun, int position, int size, int nc,
    int mp, double* in, double* out, double flow, double fhigh, int rate,
    int wintype, double gain, int autoincr, int maxpb, NOTCHDB* ptraddr);
...
__declspec(dllexport) void RXANBPSetFreqs(
