...
extern DELAY create_delay(int run, int size, double* in, double* out, int rate,
...
extern double SetDelayValue(
    DELAY a, double delay); // returns actual delay in seconds
