...
extern __declspec(dllexport) void SetRXABPSFreqs(
    int channel, double low, double high);

// TXA Prototypes

extern __declspec(dllexport) void SetTXABPSRun(int channel, int run);

extern __declspec(dllexport) void SetTXABPSFreqs(
    int channel, double low, double high);
...
extern BANDPASS create_bandpass(int run, int position, int size, int nc, int mp,
...
extern void CalcBandpassFilter(
    BANDPASS a, double f_low, double f_high, double gain);

extern __declspec(dllexport) void SetRXABandpassFreqs(
    int channel, double f_low, double f_high);
