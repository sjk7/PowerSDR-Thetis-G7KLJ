...
extern double* fir_fsamp_odd(
    int N, double* A, int rtype, double scale, int wintype);

extern double* fir_fsamp(
    int N, double* A, int rtype, double scale, int wintype);
...
extern void mp_imp(
    int N, double* fir, double* mpfir, int pfactor, int polarity);
