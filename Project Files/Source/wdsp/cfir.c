...
void calc_cfir(CFIR a) {
    ...
    impulse = cfir_impulse(a->nc, a->DD, a->R, a->Pairs, a->runrate, a->cicrate,
...
CFIR create_cfir(int run, int size, int nc, int mp, double* in, double* out,
...
double* cfir_impulse(int N, int DD, int R, int Pairs, double runrate,
