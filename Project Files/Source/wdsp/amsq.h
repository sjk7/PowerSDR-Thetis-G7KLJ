...
extern AMSQ create_amsq(int run, int size, double* in, double* out,
    double* trigger, int rate, double avtau, double tup, double tdown,
    double tail_thresh, double unmute_thresh, double min_tail, double max_tail,
    double muted_gain);
...
extern __declspec(dllexport) void SetRXAAMSQThreshold(
    int channel, double threshold);
...
extern __declspec(dllexport) void SetTXAAMSQMutedGain(
    int channel, double dBlevel);

extern __declspec(dllexport) void SetTXAAMSQThreshold(
    int channel, double threshold);
